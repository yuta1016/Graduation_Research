...
Author / revision:
  P. Kabal
  $Revision: 2.78 $  $Date: 2023/03/14 15:32:13 $
...
AFILE *
AFsetRpar(FILE *fp, enum AF_FT_T Ftype, const struct AF_read *AFr,
         enum AF_FIX_T Fix);
AFILE *
...
STdecNval(const char String[], int Nmin, int Nmax, int Type, void *Val,
          int *N);
int
STdecPair(const char String[], const char Delim[], int Type, int SignCode,
          void *Vp[2]);
int
