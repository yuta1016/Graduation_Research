...
Description:
  This routine copies characters from the input string to the output string. The
  length of the input string is considered to be equal to N less any trailing
  white-space (as defined by isspace). Characters are copied from input string
  up to the minimum of the length of the input string and Maxchar. A null
  character in the input string also terminates the transfer at that point. If
  the input string is longer than Maxchar, a string truncated warning message is
  printed.
...
Author / revision:
  P. Kabal
  $Revision: 1.16 $  $Date: 2023/03/07 16:51:44 $
