...
Description:
  ...
  delimiter characters. The allowable keywords are specified in a keyword table.
  This routine finds the index of the keyword match and returns the value
  associated with the keyword as a string.
...
Author / revision:
  P. Kabal
  $Revision: 1.20 $  $Date: 2023/04/04 19:05:01 $
