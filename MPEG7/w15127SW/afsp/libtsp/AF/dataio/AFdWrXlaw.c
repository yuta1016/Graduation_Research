...
Purpose:
  ...
  Write bit-reversed 8-bit mu-law data to an audio file (double input values)
...
Author / revision:
  P. Kabal
  $Revision: 1.15 $  $Date: 2023/03/24 11:03:10 $
...
/* ITU-T Recommendation G.711
   ...
   Mu-law data is stored in sign-magnitude bit-complemented format. The sign bit
   is 0 for positive data. The uncomplemented byte is in sign-segment-mantissa
   format.
   ...
   SPdQuantL is used to find the quantization region corresponding to each input
