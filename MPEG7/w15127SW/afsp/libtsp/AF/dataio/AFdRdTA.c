...
Description:
  These routines read a specified number of samples from an audio file. The data
  in the file is converted to double format on output.
...
Author / revision:
  P. Kabal
  $Revision: 1.13 $  $Date: 2023/03/24 10:59:25 $
