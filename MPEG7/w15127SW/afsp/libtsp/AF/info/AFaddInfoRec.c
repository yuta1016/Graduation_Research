...
Description:
  ...
  information record structure. This record consists of an identification string
  followed by the text. Additional editing of the text string is performed:
...
Author / revision:
  P. Kabal
  $Revision: 1.19 $  $Date: 2023/03/07 16:25:06 $
