...
Description:
  The input consists of an identifier for an information record. The information
  record structure consists of null terminated records. An information record
  starting with the given identifier is deleted. The information is compacted to
  recover the space used by the deleted record.
...
Author / revision:
  P. Kabal
  $Revision: 1.5 $  $Date: 2023/03/07 16:25:34 $
