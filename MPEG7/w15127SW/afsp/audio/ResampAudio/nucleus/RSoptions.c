...
Author / revision:
  P. Kabal
  $Revision: 1.26 $  $Date: 2023/04/05 15:52:45 $
...
/* Decode options */
  ...
  while (1) {
    ...
    case 2:
      /* Sampling rate ratio */
      if (STdecDfrac(OptArg, SVCODE_7x7, Dval))
        ERRSTOP(RSM_BadRatio, OptArg);
      sratio = Dval[0] / Dval[1];
      break;
    case 3:
    case 4:
      /* Alignment */
      if (STdecDfrac(OptArg, SVCODE_0x7, Dval))
