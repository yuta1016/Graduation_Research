...
#ifdef USEXML
#ifdef USEXML3
#include <xercesc/util/PlatformUtils.hpp>// Initiliase XML.
...
//    }
  ...
  */
  ...
  application_notfound&=select_application2 (ParameterSet);
  application_notfound&=select_application3 (ParameterSet);
  application_notfound&=select_application4 (ParameterSet);
