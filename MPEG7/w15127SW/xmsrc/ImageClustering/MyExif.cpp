// MyExif.cpp: implementation of the CMyExif class.
// Based on "Cexif" obtained from http://www.codeproject.com/bitmap/cexif.asp
//////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
bool CMyExif::DecodeExif(FILE * hFile)
{
    int a;
    int HaveCom = 0;
...
--------------------------------------------------------------------------*/
bool CMyExif::process_EXIF(unsigned char * CharBuf, unsigned int length)
{
...
--------------------------------------------------------------------------*/
unsigned long CMyExif::Get32u(void * Long)
{
...
--------------------------------------------------------------------------*/
bool CMyExif::ProcessExifDir(unsigned char * DirStart, unsigned char * OffsetBase, unsigned ExifLength,
...
--------------------------------------------------------------------------*/
double CMyExif::ConvertAnyFormat(void * ValuePtr, int Format)
{
    double Value;
    Value = 0;
...
////////////////////////////////////////////////////////////////////////////////
void CMyExif::process_COM (const unsigned char * Data, int length)
{
    int ch;
...
////////////////////////////////////////////////////////////////////////////////
void CMyExif::process_SOFn (const unsigned char * Data, int marker)
{
