// MyExif.h: interface for the CMyExif class.
...
protected:
	...
	int Get16u(void * aShort);
	int Get16m(void * aShort);
	long Get32s(void * aLong);
	unsigned long Get32u(void * aLong);
