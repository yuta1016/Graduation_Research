...
int Get_macroblock_type()
{
  ...
  else
  {
    ...
    case D_TYPE:
      ...
      break;
    default:
      fprintf(stderr,"Get_macroblock_type(): unrecognized picture coding type\n");
      break;
    }
  }
...
#ifdef TRACE
  if (Trace_Flag)
    fprintf(stderr,"macroblock_type(I) ");
#endif /* TRACE */
...
#ifdef TRACE
  if (Trace_Flag)
    fprintf(stderr,"(01): Intra, Quant (17)\n");
#endif /* TRACE */
...
#ifdef TRACE
  if (Trace_Flag)
    fprintf(stderr,"macroblock_type(P) (");
#endif /* TRACE */
...
#ifdef TRACE
  if (Trace_Flag)
    fprintf(stderr,"macroblock_type(B) (");
#endif /* TRACE */
...
#ifdef TRACE
  if (Trace_Flag)
    fprintf(stderr,"macroblock_type(I,spat) (");
#endif /* TRACE */
...
#ifdef TRACE
  if (Trace_Flag)
    fprintf(stderr,"macroblock_type(P,spat) (");
#endif /* TRACE */
...
#ifdef TRACE
  if (Trace_Flag)
    fprintf(stderr,"macroblock_type(B,spat) (");
#endif /* TRACE */
...
#ifdef TRACE			/* *CH* */
  if (Trace_Flag)
    fprintf(stderr,"macroblock_type(SNR) (");
#endif /* TRACE */
...
int Get_motion_code()
{
  ...
  if ((code-=12)<0)
  {
    if (!Quiet_Flag)
/* HACK */
      fprintf(stderr,"Invalid motion_vector code (MBA %d, pic %d)\n", global_MBA, global_pic);
    Fault_Flag=1;
    return 0;
  }
...
#ifdef TRACE
  if (Trace_Flag)
    fprintf(stderr,"coded_block_pattern_420 (");
#endif /* TRACE */
...
#ifdef TRACE
  if (Trace_Flag)
    fprintf(stderr,"macroblock_address_increment (");
#endif /* TRACE */
...
/*
  if (Trace_Flag)
    fprintf(stderr,"dct_dc_size_luminance: (");
*/
#endif /* TRACE */
...
/*
  if (Trace_Flag)
    fprintf(stderr,", dct_dc_differential (");
*/
#endif /* TRACE */
...
/*
  if (Trace_Flag)
    fprintf(stderr,"dct_dc_size_chrominance: (");
*/
#endif /* TRACE */
