...
unsigned char *src[];
{
  ...
  case CHROMA444:
    ch_xsize=Coded_Picture_Width;
    ch_ysize=Coded_Picture_Height;
    break;
  case CHROMA422:
    ch_xsize=Coded_Picture_Width;
    ch_ysize=Coded_Picture_Height>>1;
    break;
  case CHROMA420:
    ch_xsize=Coded_Picture_Width>>1;
    ch_ysize=Coded_Picture_Height>>1;
    break;
  default:
    ch_xsize=0;
  ...
  xyuv_show_debug(0,
		  ...
		  /* int force8*/0,
		  /* int no_sync*/0,
		  /* int (*user_proc)(int,int,int,int)*/0,
		  /* int (*close_proc)(int,int,int,int)*/0,
		  /* unsigned char *buffer*/0);

#endif //ifdnef LIS_DISP
}
