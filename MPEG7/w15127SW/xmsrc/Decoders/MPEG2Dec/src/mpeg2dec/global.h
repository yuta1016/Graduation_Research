...
#include "mpeg2dec.h"
// Ajay Divakaran/S.Herrmann for MPEG-7 Motion Vector extraction
#ifdef _VISUALC_
#include <io.h>
#else
#include <unistd.h>
...
EXTERN char *Motion_Vector_Filename;
...
/* Smolic's sync globals */

EXTERN int smolic_sync;
EXTERN int skip;
EXTERN int pics;
