...
static const int mindist = 10;               // 10
static const int window_size = 7;           // 7
static const int min_eigenvalue = 1;         // 1
static const float min_determinant = 0.01;   // 0.01
static const float min_displacement = 0.1;   // 0.1
static const int max_iterations = 10;        // 10
static const float max_residue = 10.0;       // 10.0
static const float grad_sigma = 1.0;         // 1.0
static const float smooth_sigma_fact = 0.1;  //0.1
static const float pyramid_sigma_fact = 0.9; // 0.9
static const KLT_BOOL sequentialMode = FALSE; // FALSE // PK
static const KLT_BOOL smoothBeforeSelecting = TRUE; // TRUE
static const KLT_BOOL writeInternalImages = FALSE;  // FALSE
static const int search_range = 27;          // 15 -> max: 27
static const int nSkippedPixels = 1;         // 0
