function AudioPower_SeriesOfScalar = AudioPower(auData,totalSampleNum,samplingRate,scalingRatio,elementNum,weight) 
...
for i = 1:frameNum
   ...
   meanValues = Mean_SeriesOfScalar(audioPowerData, scalingRatio, elementNum, weight_flag,weight, write_flag);
end
