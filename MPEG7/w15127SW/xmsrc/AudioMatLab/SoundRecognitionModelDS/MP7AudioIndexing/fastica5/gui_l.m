...
if strcmp(get(caller, 'Tag'), 'b_LoadData')             % Do we load new data...
  loadString = 'Load data from variable in Matlab.';
  g_FastICA_loadType = 'data';
  FIGURENAME = 'FastICA: Load data';

elseif strcmp(get(caller, 'Tag'), 'b_LoadGuess')           % ... or new initial
  loadString = 'Load initial guess for mixing matrix A from variable in Matlab.';   % guess?
...
set(h_f_FastICALoad, 'HandleVisibility', 'callback');
