...
% FASTICAG - Fast Independent Component Analysis,
...
c_FastICA_g1_strD = 'pow3|tanh|gauss';
c_FastICA_g1_strV = ['pow3';'tanh';'gaus'];
c_FastICA_g2_strD = 'pow3|tanh|gauss';
c_FastICA_g2_strV = ['pow3';'tanh';'gaus'];
c_FastICA_iSta_strD = 'random|guess';
c_FastICA_iSta_strV = ['rand ';'guess'];
c_FastICA_dMod_strD = 'on|off';
c_FastICA_dMod_strV = ['on ';'off'];
...
FIGURESIZE = [round(0.1*SCREENSIZE(3)) (SCREENSIZE(4)-round(0.1*SCREENSIZE(4))-350) 530 350];
...
set(h_f_FastICA, 'HandleVisibility', 'callback');
...
pos_l = pos_l + pos_w;
pos_w = 120;
h_t_mixedStatus = uicontrol('Parent',a, ...
  'BackgroundColor',bgc, ...
  'HorizontalAlignment','left', ...
  'Position',[pos_l pos_t pos_w pos_h], ...
...
pos_l = pos_l + pos_w;
pos_w = 50;
h_t_numOfSamp = uicontrol('Parent',a, ...
  'BackgroundColor',bgc, ...
  'HorizontalAlignment','left', ...
  'Position',[pos_l pos_t pos_w pos_h], ...
  'String','', ...
...
pos_l = pos_l + pos_w;
pos_w = 120;
h_t_whiteStatus = uicontrol('Parent',a, ...
  'BackgroundColor',bgc, ...
  'HorizontalAlignment','left', ...
  'Position',[pos_l pos_t pos_w pos_h], ...
  'String','', ...
...
pos_l = pos_l + pos_w;
pos_w = 120;
h_t_icaStatus = uicontrol('Parent',a, ...
  'BackgroundColor',bgc, ...
  'HorizontalAlignment','left', ...
  'Position',[pos_l pos_t pos_w pos_h], ...
  'String','Not yet done', ...
...
%pos_t = pos_t - 4;
pos_l = pos_frame(1) + pos_frame(3) - 6 - pos_w;
h_pm_approach = uicontrol('Parent',a, ...
  'BackgroundColor',bgc, ...
...
pos_w = 100;
pos_l = pos_frame(1) + pos_frame(3) - 6 - pos_w;
h_e_numOfIC = uicontrol('Parent',a, ...
