...
SeriesOfVectorBegin(totalSampleNum, vectorSize);


if scalingRatio == 1
	Raw = Raw_SeriesOfVector(auData,totalSampleNum);
end
write_flag = 1;   
if min_flag == 1
   minValues = Min_SeriesOfVector(auData, totalSampleNum, scalingRatio, elementNum, weight_flag, weight,write_flag);
   write_flag = 0;
end
if max_flag == 1
   maxValues = Max_SeriesOfVector(auData, totalSampleNum, scalingRatio, elementNum, weight_flag,weight, write_flag);
   write_flag = 0;   
end
if mean_flag == 1 | variance_flag == 1 | maxsqdist_flag == 1 | variancesummed_flag == 1 | covariance_flag == 1
   meanValues = Mean_SeriesOfVector(auData, totalSampleNum, scalingRatio, elementNum, weight_flag,weight, write_flag);
   write_flag = 0;   
end
if random_flag == 1
  	randomPlace = 3;
   randomValues = random_SeriesOfVector(auData, totalSampleNum, scalingRatio, elementNum, randomPlace, write_flag);
   write_flag = 0;   
end

if first_flag == 1
   firstValues = First_SeriesOfVector(auData, totalSampleNum, scalingRatio, elementNum, write_flag);
   write_flag = 0;   
end

if last_flag == 1
   lastValues = Last_SeriesOfVector(auData, totalSampleNum, scalingRatio, elementNum, write_flag);
	write_flag = 0;   
end

if mean_flag == 1 | variance_flag == 1 | maxsqdist_flag == 1 | variancesummed_flag == 1
   varanceValues = Variance_SeriesOfVector(auData, totalSampleNum, scalingRatio, elementNum, weight_flag,weight, write_flag);
   write_flag = 0;   
end
...
if mean_flag == 1 | variancesummed_flag == 1
   varanceSummedValues = varianceSummed_SeriesOfScalar(auData, totalSampleNum, scalingRatio, elementNum, weight_flag,weight, write_flag);
   write_flag = 0;   
end
%if mean_flag == 1 | variance_flag == 1 | maxsqdist_flag == 1 | variancesummed_flag == 1 
...
if weight_flag == 1
   weightValues = Weight_SeriesOfScalar(scalingRatio, elementNum, weight, write_flag);
   write_flag = 0;   
end
SeriesOfVectorEnd;
