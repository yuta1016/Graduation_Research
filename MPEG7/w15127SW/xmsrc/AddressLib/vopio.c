...
/**********************************************************************/
/*  initvop  initialises vopstructures an allocates memory            */
/**********************************************************************/
...
/*	free(vop->v_chan->data);
      }*/
      free(vop->v_chan);
    }
    if (vop->pextend) free(vop->pextend);
    free(vop);
  }
  return 0;
}
...
/**********************************************************************/
/*  initimg  initializes memory for an image                          */
/**********************************************************************/
