...
//
// Applicable File Name:  InkSegmentExtraction.h
//
#ifndef __INKSEGMENTEXTRACTION_H__
#define __INKSEGMENTEXTRACTION_H__
...
class InkSegmentExtractionTool;

//=============================================================================
class InkSegmentExtractionInterfaceABC: public I_InterfaceABC
{
public:
	InkSegmentExtractionInterfaceABC();
	virtual ~InkSegmentExtractionInterfaceABC() {};
	...
	virtual unsigned long StartExtracting(char *, char *) = 0;
	//sth interface violation
...
//=============================================================================
class InkSegmentExtractionInterface: 
  public InkSegmentExtractionInterfaceABC
{
public:
	InkSegmentExtractionInterface(InkSegmentExtractionTool*
					   aTool);
	virtual ~InkSegmentExtractionInterface();
	...
	virtual unsigned long StartExtracting(char *, char *);
	//sth interface violation
...
private:
	InkSegmentExtractionTool *m_ExtractionTool;
};

//=============================================================================
class InkSegmentExtractionTool: public DescriptorExtractor
{
friend class InkSegmentExtractionInterface;
public:
	...
	virtual InkSegmentExtractionInterfaceABC *GetInterface(void);
	...
	static const char * myName;
private:
	virtual ~InkSegmentExtractionTool();

	InkSegmentExtractionInterface m_Interface;
	...
	// Parse: Extract Relationships and creates the DS for a
	// temporal segment relationship graph
	void ExtractInkSegment(GenericDSInterfaceABC *parentDSInterface);

	//ReadInkSegmentID: Reads a segment info form a tree.txt
	...
	// ReadInkSegmentInfo: Reads media FS file for info 
	...
	// Relationship extraction and creation of SegmentRelationshipGraph DS
	void SegmentRelationshipsExtraction(int NumSegments,
					    int **ppiSegmentFramesLists, 
					    char ***pppcSegRelsList,
					    int *piNumRels);
	void InkSegmentEncoding(GenericDSInterfaceABC *parentDSInterface,
				     int NumSegments,
				     char **ppcSegmentRelationshipsList,
...
#endif //__INKSEGMENTEXTRACTION_H__
