...
//
// Applicable File Name:  Perceptual3DShapeExtraction.h
//

#ifndef __PERCEPTUAL3DSHAPEEXTRACTION_H__
#define __PERCEPTUAL3DSHAPEEXTRACTION_H__
...
class Perceptual3DShapeExtractionTool;

//=============================================================================
// This is an abstract base class to provide an interface to the extraction
// utilities.
class Perceptual3DShapeExtractionInterfaceABC: public I_InterfaceABC
{
public:
  Perceptual3DShapeExtractionInterfaceABC();
  virtual ~Perceptual3DShapeExtractionInterfaceABC() {};
...
//=============================================================================
class Perceptual3DShapeExtractionInterface: 
public Perceptual3DShapeExtractionInterfaceABC
{
public:
  // used when DummyExtraction tool is created
  Perceptual3DShapeExtractionInterface(Perceptual3DShapeExtractionTool* aTool);
  // desctructor
  virtual ~Perceptual3DShapeExtractionInterface();
  ...
  // destructs Perceptual3DShapeExtractionTool
...
private:
  Perceptual3DShapeExtractionTool *m_ExtractionTool;
};
//=============================================================================
class Perceptual3DShapeExtractionTool: public DescriptorExtractor
{
  friend class Perceptual3DShapeExtractionInterface;
public:
  // Null constructor
  ...
  virtual Perceptual3DShapeExtractionInterfaceABC *GetInterface(void);
...
private:
  ...
  virtual ~Perceptual3DShapeExtractionTool();

  Perceptual3DShapeExtractionInterface m_Interface;
...
#endif //__PERCEPTUAL3DSHAPEEXTRACTION_H__
