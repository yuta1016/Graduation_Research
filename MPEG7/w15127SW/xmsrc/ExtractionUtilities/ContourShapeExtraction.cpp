...
const UUID ContourShapeExtractionInterface::myID = UUID();
const char *ContourShapeExtractionInterface::myName = "Streaming Component Control Interface";

const UUID ContourShapeExtractionTool::myID = UUID();
const char *ContourShapeExtractionTool::myName = "Contour-Based Shape Descriptor Extractor";

const UUID ContourShapeExtractionInterfaceABC::myID = UUID();

//=============================================================================
ContourShapeExtractionInterfaceABC::ContourShapeExtractionInterfaceABC()
{
  SetInterfaceID(myID);
}

//=============================================================================
ContourShapeExtractionInterface::ContourShapeExtractionInterface(ContourShapeExtractionTool* aTool)
...
//----------------------------------------------------------------------------
ContourShapeExtractionInterface::~ContourShapeExtractionInterface()
{
}

//----------------------------------------------------------------------------
const UUID& ContourShapeExtractionInterface::GetInterfaceID(void)
{
  return myID;
}

//----------------------------------------------------------------------------
const char *ContourShapeExtractionInterface::GetName(void)
{
  return myName;
}

//----------------------------------------------------------------------------
void ContourShapeExtractionInterface::destroy(void)
{
  delete m_ExtractionTool;
}

//----------------------------------------------------------------------------
int ContourShapeExtractionInterface::
...
//----------------------------------------------------------------------------
ContourShapeDescriptorInterfaceABC *ContourShapeExtractionInterface::
...
//----------------------------------------------------------------------------
int ContourShapeExtractionInterface::
SetDescriptorInterface(ContourShapeDescriptorInterfaceABC
		       *aContourShapeDescriptorInterface)

{
  return m_ExtractionTool->SetDescriptorInterface(aContourShapeDescriptorInterface);
}

//----------------------------------------------------------------------------
unsigned long ContourShapeExtractionInterface::InitExtracting(void)
{
  return m_ExtractionTool->InitExtracting();
}

//----------------------------------------------------------------------------
unsigned long ContourShapeExtractionInterface::StartExtracting(void)
{
...
//----------------------------------------------------------------------------
bool ContourShapeExtractionTool::SupportsPush(void)
{
  return true;
}

//----------------------------------------------------------------------------
bool ContourShapeExtractionTool::SupportsPull(void)
{
  return false;
}

//----------------------------------------------------------------------------
int ContourShapeExtractionTool::SetSourceMedia(MultiMediaInterfaceABC *media)
{
  if (!media) return -1;
...
//----------------------------------------------------------------------------
ContourShapeDescriptorInterfaceABC *ContourShapeExtractionTool::
GetDescriptorInterface(void)
{
...
//----------------------------------------------------------------------------
int ContourShapeExtractionTool::
SetDescriptorInterface(ContourShapeDescriptorInterfaceABC
		       *aContourShapeDescriptorInterface)

{
  if (m_DescriptorInterface ==
    aContourShapeDescriptorInterface) return 0;

  if (m_DescriptorInterface)
    m_DescriptorInterface->release();

  m_DescriptorInterface = aContourShapeDescriptorInterface;
  if (m_DescriptorInterface)
  {
...
//----------------------------------------------------------------------------
unsigned long ContourShapeExtractionTool::InitExtracting(void)
{
  return 0UL;
}
...
//----------------------------------------------------------------------------
unsigned long ContourShapeExtractionTool::StartExtracting(void)
{
...
unsigned long ContourShapeExtractionTool::ExtractPeaks(int n, const Point2 * const &ishp)
{
  ...
  m_DescriptorInterface->SetNoOfPeaks(nPeaks);
  if (nPeaks == 0)
    m_DescriptorInterface->SetHighestPeakY(0);
  ...
  for (int i = 0; i < nPeaks; i++)
  {
    ...
    m_DescriptorInterface->SetPeak(i, qx, qy);
    if (i == 0)
      m_DescriptorInterface->SetHighestPeakY(qy);
  }

  unsigned long qe, qc;
  ExtractCurvature(n, ishp, qc, qe);
  m_DescriptorInterface->SetGlobalCurvature(qc, qe);

  if (nPeaks > 0)
  {
    ExtractCurvature(n, fshp, qc, qe);
    m_DescriptorInterface->SetPrototypeCurvature(qc, qe);
  }
...
//----------------------------------------------------------------------------
const UUID& ContourShapeExtractionTool::GetObjectID(void)
{
  return myID;
}

//----------------------------------------------------------------------------
const char *ContourShapeExtractionTool::GetName(void)
{
  return myName;
}

//----------------------------------------------------------------------------
ContourShapeExtractionInterfaceABC *ContourShapeExtractionTool::GetInterface(void)
{
  return &m_Interface;
}
