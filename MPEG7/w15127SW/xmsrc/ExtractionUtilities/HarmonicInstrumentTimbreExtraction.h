...
//
// Applicable File Name:  HarmonicInstrumentTimbreExtraction.h
//

#ifndef __HARMONIC_INSTRUMENT_TIMBRE_EXTRACTION_H__
#define __HARMONIC_INSTRUMENT_TIMBRE_EXTRACTION_H__
...
class HarmonicInstrumentTimbreExtractionTool;

//=============================================================================
// This is an abstract base class to provide an interface to the extraction
// utilities.
class HarmonicInstrumentTimbreExtractionInterfaceABC: public I_InterfaceABC
{
public:
  HarmonicInstrumentTimbreExtractionInterfaceABC();
  virtual ~HarmonicInstrumentTimbreExtractionInterfaceABC() {};
...
//=============================================================================
class HarmonicInstrumentTimbreExtractionInterface: 
public HarmonicInstrumentTimbreExtractionInterfaceABC
{
public:
  // used when HarmonicInstrumentTimbreExtraction tool is created
  HarmonicInstrumentTimbreExtractionInterface(HarmonicInstrumentTimbreExtractionTool* aTool);
  // desctructor
  virtual ~HarmonicInstrumentTimbreExtractionInterface();
  ...
  // destructs HarmonicInstrumentTimbreExtractionTool
...
private:
  HarmonicInstrumentTimbreExtractionTool *m_ExtractionTool;
};
//=============================================================================
class HarmonicInstrumentTimbreExtractionTool: public DescriptorExtractor
{
  friend class HarmonicInstrumentTimbreExtractionInterface;
public:
  // Null constructor
  ...
  virtual HarmonicInstrumentTimbreExtractionInterfaceABC *GetInterface(void);
...
private:
  ...
  virtual ~HarmonicInstrumentTimbreExtractionTool();

  HarmonicInstrumentTimbreExtractionInterface m_Interface;
...
#endif //__HARMONIC_INSTRUMENT_TIMBRE_EXTRACTION_H__
