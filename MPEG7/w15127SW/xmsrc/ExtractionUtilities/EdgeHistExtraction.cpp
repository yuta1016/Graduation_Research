...
const UUID EdgeHistogramExtractionInterface::myID = UUID("");
const char *EdgeHistogramExtractionInterface::myName = 
"EdgeHistogramDescriptorExtractorInterface";

const UUID EdgeHistogramExtractionTool::myID = UUID("");
const char *EdgeHistogramExtractionTool::myName =
"EdgeHistogramDescriptorExtractor";

const UUID EdgeHistogramExtractionInterfaceABC::myID = UUID();

//=============================================================================
EdgeHistogramExtractionInterfaceABC::EdgeHistogramExtractionInterfaceABC()
{
  SetInterfaceID(myID);
}

//=============================================================================
EdgeHistogramExtractionInterface::
EdgeHistogramExtractionInterface(EdgeHistogramExtractionTool* aTool):
...
//----------------------------------------------------------------------------
EdgeHistogramExtractionInterface::~EdgeHistogramExtractionInterface()
{
}

//----------------------------------------------------------------------------
const UUID& EdgeHistogramExtractionInterface::GetInterfaceID(void)
{ return myID; }

//----------------------------------------------------------------------------
const char *EdgeHistogramExtractionInterface::GetName(void)
{ return myName; }


//----------------------------------------------------------------------------
void EdgeHistogramExtractionInterface::destroy(void)
{ delete m_ExtractionTool; }

//----------------------------------------------------------------------------
// This informs the extractor where the source data is coming from. This
// could be an audio file, image stream etc.
int EdgeHistogramExtractionInterface::
...
//----------------------------------------------------------------------------
EdgeHistogramDescriptorInterfaceABC* EdgeHistogramExtractionInterface::
...
//----------------------------------------------------------------------------
unsigned long EdgeHistogramExtractionInterface::InitExtracting(void)
...
//----------------------------------------------------------------------------
unsigned long EdgeHistogramExtractionInterface::StartExtracting(void)
...
//----------------------------------------------------------------------------
unsigned long EdgeHistogramExtractionInterface::PostExtracting(void)
...
//----------------------------------------------------------------------------
EdgeHistogramDescriptorInterfaceABC* EdgeHistogramExtractionTool::
GetDescriptorInterface(void)
...
//----------------------------------------------------------------------------
int EdgeHistogramExtractionTool::
SetDescriptorInterface(EdgeHistogramDescriptorInterfaceABC
		       *aEdgeHistogramDescriptorInterface)

{
  /* check if new value is different from old value*/
  if (m_DescriptorInterface == aEdgeHistogramDescriptorInterface) return 0;

  /* release old interface*/
  if (m_DescriptorInterface) m_DescriptorInterface->release();

  /* add new interface*/
  m_DescriptorInterface = aEdgeHistogramDescriptorInterface;
  if (m_DescriptorInterface) {
...
// into the 
unsigned long EdgeHistogramExtractionTool::StartExtracting(void)
...
// arbitrary shape (Modified by Dongguk)
	...
	for( j=0; j < ysize; j++){
		for( i=0; i < xsize; i++) {
			if(alpha_channel_ok && ImageMedia->a_chan){
...
// end modification
	m_DescriptorInterface->SetEdgeHistogram( pLocal_Edge );
...
//----------------------------------------------------------------------------
const UUID& EdgeHistogramExtractionTool::GetObjectID(void)
{ return myID; }

//----------------------------------------------------------------------------
const char *EdgeHistogramExtractionTool::GetName(void)
{ return myName; }

//----------------------------------------------------------------------------
EdgeHistogramExtractionInterfaceABC *EdgeHistogramExtractionTool::GetInterface(void)
{ return &m_Interface; }
