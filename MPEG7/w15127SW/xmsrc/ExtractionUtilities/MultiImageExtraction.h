...
//
// Applicable File Name:  MultiImageExtraction.h
//

#ifndef __MULTIIMAGEEXTRACTION_H__
#define __MULTIIMAGEEXTRACTION_H__
...
class MultiImageExtractionTool;

//=============================================================================
// This is an abstract base class to provide an interface to the extraction
// utilities.
class MultiImageExtractionInterfaceABC: public I_InterfaceABC
{
public:
  MultiImageExtractionInterfaceABC();
  virtual ~MultiImageExtractionInterfaceABC() {};
  ...
  virtual int SetDescriptorInterface(MultiImageDescriptorInterfaceABC
...
//=============================================================================
class MultiImageExtractionInterface: 
public MultiImageExtractionInterfaceABC
{
public:
  // used when DummyExtraction tool is created
  MultiImageExtractionInterface(MultiImageExtractionTool* aTool);
  // desctructor
  virtual ~MultiImageExtractionInterface();
  ...
  // destructs MultiImageExtractionTool
...
private:
  MultiImageExtractionTool *m_ExtractionTool;
};
//=============================================================================
class MultiImageExtractionTool: public DescriptorExtractor
{
  friend class MultiImageExtractionInterface;
public:
  // Null constructor
  ...
  virtual MultiImageExtractionInterfaceABC *GetInterface(void);
...
private:
  ...
  virtual ~MultiImageExtractionTool();

  MultiImageExtractionInterface m_Interface;
  MultiImageDescriptorInterfaceABC *m_DescriptorInterface;
  MultiMediaInterfaceABC* m_Media;

  ScalableColorExtractionInterfaceABC *m_ScalableColorExtraction;
  ContourShapeExtractionInterfaceABC *m_ContourShapeExtraction;
}; // End class

}; // End namespace


#endif //__MULTIIMAGEEXTRACTION_H__
