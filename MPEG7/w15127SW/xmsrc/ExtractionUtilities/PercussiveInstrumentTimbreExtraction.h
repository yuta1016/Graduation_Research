...
//
// Applicable File Name:  PercussiveInstrumentTimbreExtraction.h
//

#ifndef __PERCUSSIVE_INSTRUMENT_TIMBRE_EXTRACTION_H__
#define __PERCUSSIVE_INSTRUMENT_TIMBRE_EXTRACTION_H__
...
#include <stdio.h> // For FILE* type declaration
...
class PercussiveInstrumentTimbreExtractionTool;

//=============================================================================
// This is an abstract base class to provide an interface to the extraction
// utilities.
class PercussiveInstrumentTimbreExtractionInterfaceABC: public I_InterfaceABC
{
public:
  PercussiveInstrumentTimbreExtractionInterfaceABC();
  virtual ~PercussiveInstrumentTimbreExtractionInterfaceABC() {};
  ...
  virtual int SetDescriptorInterface(PercussiveInstrumentTimbreDescriptorInterfaceABC
  ...
  virtual unsigned long InitExtracting(std::string mediaName) = 0;
...
//=============================================================================
class PercussiveInstrumentTimbreExtractionInterface: 
public PercussiveInstrumentTimbreExtractionInterfaceABC
{
public:
  // used when PercussiveInstrumentTimbreExtraction tool is created
  PercussiveInstrumentTimbreExtractionInterface(PercussiveInstrumentTimbreExtractionTool* aTool);
  // desctructor
  virtual ~PercussiveInstrumentTimbreExtractionInterface();
  ...
  // destructs PercussiveInstrumentTimbreExtractionTool
  ...
  virtual unsigned long InitExtracting(std::string mediaName);
...
private:
  PercussiveInstrumentTimbreExtractionTool *m_ExtractionTool;
};


//=============================================================================
class PercussiveInstrumentTimbreExtractionTool: public DescriptorExtractor
{
  friend class PercussiveInstrumentTimbreExtractionInterface;
public:
  // Null constructor
  ...
  virtual unsigned long InitExtracting(void);
  virtual unsigned long InitExtracting(std::string mediaName);
  //sth media name should be part of Media object given with SetSourceMedia
  ...
  virtual PercussiveInstrumentTimbreExtractionInterfaceABC *GetInterface(void);
...
private:
  ...
  virtual ~PercussiveInstrumentTimbreExtractionTool();

  PercussiveInstrumentTimbreExtractionInterface m_Interface;
  PercussiveInstrumentTimbreDescriptorInterfaceABC *m_DescriptorInterface;
  MultiMediaInterfaceABC* m_Media;

  char* m_ExtractionMatlabScript;
  Engine* m_ExtractionEngine;
...
#endif //__PERCUSSIVE_INSTRUMENT_TIMBRE_EXTRACTION_H__
