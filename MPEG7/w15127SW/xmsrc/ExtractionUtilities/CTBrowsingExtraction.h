...
//
// Applicable File Name:  CTBrowsingExtraction.h
//

#ifndef __CTBROWSINGEXTRACTION_H__
#define __CTBROWSINGEXTRACTION_H__
...
#include "ExtractionUtilities/CTBrowsing_Extraction.h"

namespace XM
{

// Forward Declarations:
class CTBrowsingExtractionTool;

//=============================================================================
// This is an abstract base class to provide an interface to the extraction
// utilities.
class CTBrowsingExtractionInterfaceABC: public I_InterfaceABC
{
public:
  CTBrowsingExtractionInterfaceABC();
  virtual ~CTBrowsingExtractionInterfaceABC() {};
  ...
  // are written to
  virtual CTBrowsingDescriptorInterfaceABC* GetDescriptorInterface(void) = 0;
...
//=============================================================================
class CTBrowsingExtractionInterface: 
public CTBrowsingExtractionInterfaceABC
{
public:
  // used when DummyExtraction tool is created
  CTBrowsingExtractionInterface(CTBrowsingExtractionTool* aTool);
  // desctructor
  virtual ~CTBrowsingExtractionInterface();
  ...
  // destructs CTBrowsingExtractionTool
...
private:
  CTBrowsingExtractionTool *m_ExtractionTool;
};
//=============================================================================
class CTBrowsingExtractionTool: public DescriptorExtractor
{
  friend class CTBrowsingExtractionInterface;
public:
  // Null constructor
...
//  virtual unsigned long InitExtracting(void);
  ...
  virtual CTBrowsingExtractionInterfaceABC *GetInterface(void);
...
private:
  ...
  virtual ~CTBrowsingExtractionTool();

  CTBrowsingExtractionInterface m_Interface;
...
#endif //__CTBROWSINGEXTRACTION_H__
