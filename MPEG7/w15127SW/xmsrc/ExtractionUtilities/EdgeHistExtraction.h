...
// utilities.
class EdgeHistogramExtractionInterfaceABC: public I_InterfaceABC
{
public:
  EdgeHistogramExtractionInterfaceABC();
  virtual ~EdgeHistogramExtractionInterfaceABC() {};
...
//=============================================================================
class EdgeHistogramExtractionInterface: 
public EdgeHistogramExtractionInterfaceABC
{
public:
  // used when DummyExtraction tool is created
  EdgeHistogramExtractionInterface(EdgeHistogramExtractionTool* aTool);
  // desctructor
  virtual ~EdgeHistogramExtractionInterface();
  ...
  // destructs EdgeHistogramExtractionTool
...
private:
  EdgeHistogramExtractionTool *m_ExtractionTool;
};

//=============================================================================
class EdgeHistogramExtractionTool: public DescriptorExtractor
{
  friend class EdgeHistogramExtractionInterface;
public:
  // Null constructor
  ...
  EdgeHistogramExtractionTool(EdgeHistogramDescriptorInterfaceABC
			     *aEdgeHistogram);
...
private:
  ...
  virtual ~EdgeHistogramExtractionTool();

  EdgeHistogramExtractionInterface m_Interface;
  EdgeHistogramDescriptorInterfaceABC *m_DescriptorInterface;
  MultiMediaInterfaceABC* m_Media;
  unsigned long m_FrameCnt;
  int m_EdgeHistogramExtractionParameter;	
  
  virtual unsigned long GetBlockSize(unsigned long image_width,
	unsigned long image_height, unsigned long desired_num_of_blocks);
  virtual void EdgeHistogramGeneration(unsigned char* pImage_Y,
					     unsigned long image_width,
					     unsigned long image_height,
					     unsigned long block_size,
					     EHD* pLocal_Edge, int Te_Value);
  virtual int GetEdgeFeature(unsigned char *pImage_Y,
