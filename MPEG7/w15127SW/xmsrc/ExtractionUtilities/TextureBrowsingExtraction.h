...
//
// Applicable File Name:  TextureBrowsingExtraction.h
//
#ifndef __TEXTUREBROWSINGEXTRCATION_H__
#define __TEXTUREBROWSINGEXTRCATION_H__
...
#include "texture_browsing_extraction.h"	//yjyu - 010218

namespace XM
{

// Forward Declarations:
class TextureBrowsingExtractionTool;

//=============================================================================
// This is an abstract base class to provide an interface to the extraction
// utilities.
class TextureBrowsingExtractionInterfaceABC: public I_InterfaceABC
{
public:
  TextureBrowsingExtractionInterfaceABC();
  virtual ~TextureBrowsingExtractionInterfaceABC() {};
  ...
  virtual int SetDescriptorInterface(TextureBrowsingDescriptorInterfaceABC
...
//=============================================================================
class TextureBrowsingExtractionInterface: 
public TextureBrowsingExtractionInterfaceABC
{
public:
  // used when TextureBrowsingExtraction tool is created
  TextureBrowsingExtractionInterface(TextureBrowsingExtractionTool* aTool);
  // desctructor
  virtual ~TextureBrowsingExtractionInterface();
  ...
  // destructs TextureBrowsingExtractionTool
...
private:
  TextureBrowsingExtractionTool *m_ExtractionTool;
};
//=============================================================================
class TextureBrowsingExtractionTool: public DescriptorExtractor
{
  friend class TextureBrowsingExtractionInterface;
public:
  // Null constructor
  ...
  virtual TextureBrowsingExtractionInterfaceABC *GetInterface(void);
...
private:
  ...
  virtual ~TextureBrowsingExtractionTool();

  TextureBrowsingExtractionInterface m_Interface;
  TextureBrowsingDescriptorInterfaceABC *m_DescriptorInterface;
...
#endif //__TextureBrowsingEXTRACTION_H__
