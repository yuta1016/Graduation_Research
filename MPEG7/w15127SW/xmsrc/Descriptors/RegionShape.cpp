...
const UUID RegionShapeDescriptorInterface::myID = UUID("e8cc4680-71d3-11d3-9135-c24a67000000");
const char *RegionShapeDescriptorInterface::myName = "Region Shape Descriptor Interface";

const UUID RegionShapeDescriptor::myID = UUID("015940b0-71d4-11d3-9135-c24a67000000");
const char *RegionShapeDescriptor::myName = "Region Shape Descriptor";

const UUID RegionShapeDescriptor::valID = UUID("079f42c0-71d4-11d3-9135-c24a67000000");
const char *RegionShapeDescriptor::valName = "Region Shape Descriptor";

const UUID RegionShapeDescriptorInterfaceABC::myID = UUID("07f96ad0-71d4-11d3-9135-c24a67000000");
...
//----------------------------------------------------------------------------
RegionShapeDescriptorInterfaceABC::RegionShapeDescriptorInterfaceABC()
{ SetInterfaceID(myID);}

//----------------------------------------------------------------------------
RegionShapeDescriptorInterface::RegionShapeDescriptorInterface(RegionShapeDescriptor *aRegionShape):
m_RegionShapeDescriptor(aRegionShape)
{
	SetInterfaceID(myID);
}

//----------------------------------------------------------------------------
RegionShapeDescriptorInterface::~RegionShapeDescriptorInterface()
{
}

//----------------------------------------------------------------------------
void RegionShapeDescriptorInterface::addref(void)
{ m_RegionShapeDescriptor->addref(); }


//----------------------------------------------------------------------------
void RegionShapeDescriptorInterface::release(void)
{ m_RegionShapeDescriptor->release(); }


//----------------------------------------------------------------------------
const UUID& RegionShapeDescriptorInterface::GetInterfaceID(void)
{ return myID; }


//----------------------------------------------------------------------------
const char *RegionShapeDescriptorInterface::GetName(void)
{ return myName; }


//----------------------------------------------------------------------------
bool RegionShapeDescriptorInterface::SetElement(char p, char r, char value)
{
	return m_RegionShapeDescriptor->SetElement(p, r, value);
}

//----------------------------------------------------------------------------
bool RegionShapeDescriptorInterface::SetElement(char p, char r, double value)
{
	return m_RegionShapeDescriptor->SetElement(p, r, value);
}
...
//----------------------------------------------------------------------------
char RegionShapeDescriptorInterface::GetElement(char p, char r)
{
	return m_RegionShapeDescriptor->GetElement(p, r);
}

//----------------------------------------------------------------------------
double RegionShapeDescriptorInterface::GetRealValue(char p, char r)
{
	return m_RegionShapeDescriptor->GetRealValue(p, r);
}

//-----------------------------------------------------------------------------
unsigned long RegionShapeDescriptorInterface::ExportDDL(GenericDSInterfaceABC *aParentDescription)
{
  return m_RegionShapeDescriptor->ExportDDL(aParentDescription);
}

//-----------------------------------------------------------------------------
unsigned long RegionShapeDescriptorInterface::ImportDDL(GenericDSInterfaceABC *aDescription)
{
  return m_RegionShapeDescriptor->ImportDDL(aDescription);
}
...
//----------------------------------------------------------------------------
RegionShapeDescriptorInterfaceABC *RegionShapeDescriptor::GetInterface(void)
{ return &m_Interface; }

//----------------------------------------------------------------------------
const char *RegionShapeDescriptor::GetName(void)
{ return myName; }

//----------------------------------------------------------------------------
const UUID& RegionShapeDescriptor::GetObjectID(void)
{ return myID; }

//----------------------------------------------------------------------------
const UUID& RegionShapeDescriptor::GetValueID(void)
{ return valID; }

//----------------------------------------------------------------------------
const char* RegionShapeDescriptor::GetValueName(void)
{ return valName; }

//----------------------------------------------------------------------------
bool RegionShapeDescriptor::IsProprietary(void)
{ return m_isProprietary; }


//----------------------------------------------------------------------------
void RegionShapeDescriptor::addref(void)
{
#ifdef VERBOSE
       fprintf(stderr,"RegionShape connect\n");
#endif
       m_refcount++;
}

//----------------------------------------------------------------------------
void RegionShapeDescriptor::release(void)
{
#ifdef VERBOSE
       fprintf(stderr,"RegionShape release\n");
#endif
       if (!(--m_refcount)) delete this;
}

//----------------------------------------------------------------------------
bool RegionShapeDescriptor::SetElement(char p, char r, char value)
{
...
//----------------------------------------------------------------------------
bool RegionShapeDescriptor::SetElement(char p, char r, double value)
{
	if (p<0 || p>=ART_ANGULAR || r<0 || r>=ART_RADIAL ||
	    value>1.0 || value<0.0)
		return false;
...
//----------------------------------------------------------------------------
char RegionShapeDescriptor::GetElement(char p, char r)
{
	if (p<0 || p>=ART_ANGULAR || r<0 || r>=ART_RADIAL)
		return -1;
...
//----------------------------------------------------------------------------
double RegionShapeDescriptor::GetRealValue(char p, char r)
{
	if (p<0 || p>=ART_ANGULAR || r<0 || r>=ART_RADIAL)
		return -1;
