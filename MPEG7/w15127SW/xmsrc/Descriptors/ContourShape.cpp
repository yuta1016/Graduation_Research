...
const UUID ContourShapeDescriptorInterface::myID = UUID("");
const char *ContourShapeDescriptorInterface::myName = "Contour-Based Shape Description Interface";

const UUID ContourShapeDescriptor::myID = UUID("");
const char *ContourShapeDescriptor::myName = "Contour-Based Shape Descriptor";

const UUID ContourShapeDescriptor::valID = UUID("");
const char *ContourShapeDescriptor::valName = "Contour-Based Shape Descriptor";

const UUID ContourShapeDescriptorInterfaceABC::myID = UUID();

ContourShapeDescriptorInterfaceABC::ContourShapeDescriptorInterfaceABC()
{
  SetInterfaceID(myID);
}
...
ContourShapeDescriptorInterface::ContourShapeDescriptorInterface(ContourShapeDescriptor *pContourShape)
: m_pContourShapeDescriptor(pContourShape)
{
  SetInterfaceID(myID);
}

//-----------------------------------------------------------------------------
ContourShapeDescriptorInterface::~ContourShapeDescriptorInterface()
{
}

//-----------------------------------------------------------------------------
void ContourShapeDescriptorInterface::addref(void)
{
  m_pContourShapeDescriptor->addref();
}

//-----------------------------------------------------------------------------
void ContourShapeDescriptorInterface::release(void)
{
  m_pContourShapeDescriptor->release();
}

//-----------------------------------------------------------------------------
const UUID& ContourShapeDescriptorInterface::GetInterfaceID(void)
{
  return myID;
}

//-----------------------------------------------------------------------------
const char *ContourShapeDescriptorInterface::GetName(void)
{
  return myName;
}

//-----------------------------------------------------------------------------
void ContourShapeDescriptorInterface::SetNoOfPeaks(unsigned char cPeaks)
{
  m_pContourShapeDescriptor->SetNoOfPeaks(cPeaks);
}

//-----------------------------------------------------------------------------
unsigned char ContourShapeDescriptorInterface::GetNoOfPeaks() const
{
  return m_pContourShapeDescriptor->GetNoOfPeaks();
}

//-----------------------------------------------------------------------------
void ContourShapeDescriptorInterface::SetGlobalCurvature(unsigned long lC, unsigned long lE)
{
  m_pContourShapeDescriptor->SetGlobalCurvature(lC, lE);
}

//-----------------------------------------------------------------------------
void ContourShapeDescriptorInterface::GetGlobalCurvature(unsigned long &lC, unsigned long &lE) const
{
  m_pContourShapeDescriptor->GetGlobalCurvature(lC, lE);
}

//-----------------------------------------------------------------------------
void ContourShapeDescriptorInterface::SetPrototypeCurvature(unsigned long lC, unsigned long lE)
{
  m_pContourShapeDescriptor->SetPrototypeCurvature(lC, lE);
}

//-----------------------------------------------------------------------------
void ContourShapeDescriptorInterface::GetPrototypeCurvature(unsigned long &lC, unsigned long &lE) const
{
  m_pContourShapeDescriptor->GetPrototypeCurvature(lC, lE);
}

//-----------------------------------------------------------------------------
void ContourShapeDescriptorInterface::SetHighestPeakY(unsigned short iHigh)
{
  m_pContourShapeDescriptor->SetHighestPeakY(iHigh);
}

//-----------------------------------------------------------------------------
unsigned short ContourShapeDescriptorInterface::GetHighestPeakY() const
{
  return m_pContourShapeDescriptor->GetHighestPeakY();
}

//-----------------------------------------------------------------------------
void ContourShapeDescriptorInterface::SetPeak(unsigned char cIndex, unsigned short iX, unsigned short iY)
{
  m_pContourShapeDescriptor->SetPeak(cIndex, iX, iY);
}

//-----------------------------------------------------------------------------
void ContourShapeDescriptorInterface::GetPeak(unsigned char cIndex, unsigned short &iX, unsigned short &iY)
{
  m_pContourShapeDescriptor->GetPeak(cIndex, iX, iY);
}

//-----------------------------------------------------------------------------
unsigned long ContourShapeDescriptorInterface::ExportDDL(GenericDSInterfaceABC *aParentDescription)
{
  return m_pContourShapeDescriptor->ExportDDL(aParentDescription);
}

//-----------------------------------------------------------------------------
unsigned long ContourShapeDescriptorInterface::ImportDDL(GenericDSInterfaceABC *aDescription)
{
  return m_pContourShapeDescriptor->ImportDDL(aDescription);
}
...
//-----------------------------------------------------------------------------
const UUID& ContourShapeDescriptor::GetObjectID(void)
{
  return myID;
}

//-----------------------------------------------------------------------------
const char *ContourShapeDescriptor::GetName(void)
{
  return myName;
}

//-----------------------------------------------------------------------------
const UUID& ContourShapeDescriptor::GetValueID(void)
{
  return valID;
}

//-----------------------------------------------------------------------------
const char* ContourShapeDescriptor::GetValueName(void)
{
  return valName;
}
...
//-----------------------------------------------------------------------------
bool ContourShapeDescriptor::IsProprietary(void)
{
  return m_isProprietary;
}

//-----------------------------------------------------------------------------
void ContourShapeDescriptor::addref(void)
{
#ifdef VERBOSE
  fprintf(stderr, "ContourShape connect\n");
#endif // VERBOSE
  m_refcount++;
}

//-----------------------------------------------------------------------------
void ContourShapeDescriptor::release(void)
{
#ifdef VERBOSE
  fprintf(stderr, "ContourShape release\n");
#endif // VERBOSE
  if (!(--m_refcount)) delete this;
}

//-----------------------------------------------------------------------------
ContourShapeDescriptorInterfaceABC *ContourShapeDescriptor::GetInterface(void)
{
  return &m_Interface;
}
