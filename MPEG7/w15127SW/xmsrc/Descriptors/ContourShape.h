...
class ContourShapeDescriptorInterfaceABC: public I_InterfaceABC
{
public:
	ContourShapeDescriptorInterfaceABC();
	...
	virtual void SetNoOfPeaks(unsigned char cPeaks) = 0;
	virtual unsigned char GetNoOfPeaks() const = 0;
	virtual void SetGlobalCurvature(unsigned long lC, unsigned long lE) = 0;
	virtual void GetGlobalCurvature(unsigned long &lC, unsigned long &lE) const = 0;
	virtual void SetPrototypeCurvature(unsigned long lC, unsigned long lE) = 0;
	virtual void GetPrototypeCurvature(unsigned long &lC, unsigned long &lE) const = 0;
	virtual void SetHighestPeakY(unsigned short iHigh) = 0;
	virtual unsigned short GetHighestPeakY() const = 0;
	virtual void SetPeak(unsigned char cIndex, unsigned short iX, unsigned short iY) = 0;
	virtual void GetPeak(unsigned char cIndex, unsigned short &iX, unsigned short &iY) = 0;
...
//#===--------------------------------------
//#===--- ContourShapeDescriptorInterface

class ContourShapeDescriptorInterface: public ContourShapeDescriptorInterfaceABC
{
public:
	ContourShapeDescriptorInterface(ContourShapeDescriptor *pContourShape);
	virtual ~ContourShapeDescriptorInterface();
...
private:
	ContourShapeDescriptor *m_pContourShapeDescriptor;	
};

//#===-----------------------------
//#===--- ContourShapeDescriptor

class ContourShapeDescriptor: public Descriptor
{
friend class ContourShapeDescriptorInterface;
public:
	ContourShapeDescriptor();
	...
	virtual ContourShapeDescriptorInterfaceABC *GetInterface(void);
...
private:
	...
	ContourShapeDescriptorInterface m_Interface;
