...
//
// Applicable File Name:  GoFGoPColorCS.h
//
//
#ifndef __GoFGoPColorCS__
#define __GoFGoPColorCS__

#include "Descriptors/Descriptors.h"
#include "Utilities/BitBuffer.h"
#include "ColorSpaceCS.h"
#include "ScalableColorCS.h"
...
//=============================================================================
class GoFGoPColorCSInterfaceABC: public I_InterfaceABC
{
public:
  GoFGoPColorCSInterfaceABC();
  virtual ~GoFGoPColorCSInterfaceABC() {}
  ...
  virtual int SetDescriptorInterface(GoFGoPColorDescriptorInterfaceABC
				     *aGoFGoPColorDescriptorInterfac) = 0;
...
//=============================================================================
class GoFGoPColorCSInterface: public GoFGoPColorCSInterfaceABC
{
public:
  GoFGoPColorCSInterface(GoFGoPColorCS *anCS);
  virtual ~GoFGoPColorCSInterface();
  ...
  virtual int SetDescriptorInterface(GoFGoPColorDescriptorInterfaceABC
				     *aGoFGoPColorDescriptorInterfac);

  virtual int StartEncode();
  virtual int StartDecode();

private:
	GoFGoPColorCS *m_GoFGoPColorCS;	
};


//=============================================================================
class GoFGoPColorCS: public DescriptionCodingEngine
{
friend class GoFGoPColorCSInterface;
public:
 GoFGoPColorCS();
 GoFGoPColorCS(GoFGoPColorDescriptorInterfaceABC
	     *GoFGoPColor);
 ...
 virtual GoFGoPColorCSInterfaceABC *GetInterface(void);
...
private:
 virtual ~GoFGoPColorCS();

 GoFGoPColorCSInterface m_Interface;
