...
//
// Applicable File Name:  ColorLayoutCS.h
#ifndef __ColorLayoutCS__
#define __ColorLaoutCS__
...
//=============================================================================
class ColorLayoutCSInterfaceABC: public I_InterfaceABC
{
public:
	ColorLayoutCSInterfaceABC();
	virtual ~ColorLayoutCSInterfaceABC() {}
	...
	virtual int SetDescriptorInterface(ColorLayoutDescriptorInterfaceABC
				*aColorLayoutDescriptorInterfac) = 0;
...
//=============================================================================
class ColorLayoutCSInterface: public ColorLayoutCSInterfaceABC
{
public:
	ColorLayoutCSInterface(ColorLayoutCS *anCS);
	virtual ~ColorLayoutCSInterface();
	...
	virtual int SetDescriptorInterface(ColorLayoutDescriptorInterfaceABC
				*aColorLayoutDescriptorInterfac);
	virtual int StartEncode();
	virtual int StartDecode();

private:
	ColorLayoutCS *m_ColorLayoutCS;	
};


//=============================================================================
class ColorLayoutCS: public DescriptionCodingEngine
{
friend class ColorLayoutCSInterface;
public:
	ColorLayoutCS();
        // start modification for version 3.0
        ColorLayoutCS(ColorLayoutDescriptorInterfaceABC *colorlayout);
        // end modification for version 3.0
//	virtual ~ColorLayoutCS();
	...
	virtual ColorLayoutCSInterfaceABC *GetInterface(void);
...
private:
	...
	ColorLayoutCSInterface m_Interface;
