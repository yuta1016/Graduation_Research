...
//
// Applicable File Name:  ScalableColorCS.h
#ifndef __ScalableColorCS__
#define __ScalableColorCS__
...
//=============================================================================
class ScalableColorCSInterfaceABC: public I_InterfaceABC
{
public:
	ScalableColorCSInterfaceABC();
	virtual ~ScalableColorCSInterfaceABC() {}
	...
	virtual int SetDescriptorInterface(ScalableColorDescriptorInterfaceABC
				*aScalableColorDescriptorInterfac) = 0;

	virtual int StartEncode() = 0;
	virtual int StartDecode() = 0;
};

class ScalableColorCS;

//=============================================================================
class ScalableColorCSInterface: public ScalableColorCSInterfaceABC
{
public:
	ScalableColorCSInterface(ScalableColorCS *anCS);
	virtual ~ScalableColorCSInterface();
	...
	virtual int SetDescriptorInterface(ScalableColorDescriptorInterfaceABC
				*aScalableColorDescriptorInterfac);

	virtual int StartEncode();
	virtual int StartDecode();

private:
	ScalableColorCS *m_ScalableColorCS;	
};


//=============================================================================
class ScalableColorCS: public DescriptionCodingEngine
{
friend class ScalableColorCSInterface;
public:
	ScalableColorCS();
	ScalableColorCS(ScalableColorDescriptorInterfaceABC
			 *ScalableColor);
	...
	virtual ScalableColorCSInterfaceABC *GetInterface(void);
...
private:
	virtual ~ScalableColorCS();

	ScalableColorCSInterface m_Interface;
