...
//
// Applicable File Name:  TimePointCS.h
#ifndef __TimePointCS__
#define __TimePointCS__
...
//=============================================================================
class TimePointCSInterfaceABC: public I_InterfaceABC
{
public:
	TimePointCSInterfaceABC();
	virtual ~TimePointCSInterfaceABC() {}
	...
	virtual int SetDescriptorInterface(TimePointDescriptorInterfaceABC
				    *aTimePointDescriptorInterface) = 0;
...
//=============================================================================
class TimePointCSInterface: public TimePointCSInterfaceABC
{
public:
	TimePointCSInterface(TimePointCS *anCS);
	virtual ~TimePointCSInterface();
	...
	virtual TimePointDescriptorInterfaceABC *GetDescriptorInterface(void);
	virtual int SetDescriptorInterface(TimePointDescriptorInterfaceABC
...
//=============================================================================
class TimePointCS: public DescriptionCodingEngine
{
public:
	TimePointCS();
	virtual ~TimePointCS();
	...
	virtual TimePointCSInterfaceABC *GetInterface(void);
...
private:
	...
	TimePointCSInterface m_Interface;
	...
	TimePointDescriptorInterfaceABC *m_TimePointDescriptorInterface;
};

};

#endif //__TimePointCS__
