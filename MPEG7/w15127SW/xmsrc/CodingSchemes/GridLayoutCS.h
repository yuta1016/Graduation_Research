...
//
// Applicable File Name:  GridLayoutCS.h
#ifndef __GRID_LAYOUT_CS_H__
#define __GRID_LAYOUT_CS_H__
...
//=============================================================================
class GridLayoutCSInterfaceABC: public I_InterfaceABC
{
public:
  GridLayoutCSInterfaceABC();
  virtual ~GridLayoutCSInterfaceABC() {}
  ...
  virtual int SetDescriptorInterface(GridLayoutDescriptorInterfaceABC
				     *aGridLayoutDescriptorInterfac) = 0;
...
//=============================================================================
class GridLayoutCSInterface: public GridLayoutCSInterfaceABC
{
public:
  GridLayoutCSInterface(GridLayoutCS *anCS);
  virtual ~GridLayoutCSInterface();
  ...
  virtual int SetDescriptorInterface(GridLayoutDescriptorInterfaceABC
				     *aGridLayoutDescriptorInterfac);

  virtual int StartEncode();
  virtual int StartDecode();

private:
	GridLayoutCS *m_GridLayoutCS;	
};


//=============================================================================
class GridLayoutCS: public DescriptionCodingEngine
{
friend class GridLayoutCSInterface;
public:
 GridLayoutCS();
 GridLayoutCS(GridLayoutDescriptorInterfaceABC
	     *GridLayoutType);
 ...
 virtual GridLayoutCSInterfaceABC *GetInterface(void);
...
private:
 virtual ~GridLayoutCS();

 GridLayoutCSInterface m_Interface;
