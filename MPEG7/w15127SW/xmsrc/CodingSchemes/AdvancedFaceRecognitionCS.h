...
//
// Applicable File Name:  AdvancedFaceRecognitionCS.h
//


#ifndef __AdvancedFaceRecognitionCS_H__
#define __AdvancedFaceRecognitionCS_H__
...
//=============================================================================
class AdvancedFaceRecognitionCSInterfaceABC: public I_InterfaceABC
  {
  public:
    AdvancedFaceRecognitionCSInterfaceABC();
    virtual ~AdvancedFaceRecognitionCSInterfaceABC() {}
...
class AdvancedFaceRecognitionCS;
  
//=============================================================================
class AdvancedFaceRecognitionCSInterface: public AdvancedFaceRecognitionCSInterfaceABC
{
public:
  AdvancedFaceRecognitionCSInterface(AdvancedFaceRecognitionCS *anCS);
  virtual ~AdvancedFaceRecognitionCSInterface();
  ...
  virtual AdvancedFaceRecognitionDescriptorInterfaceABC *GetDescriptorInterface(void);
  virtual int SetDescriptorInterface(AdvancedFaceRecognitionDescriptorInterfaceABC
...
private:
  AdvancedFaceRecognitionCS *m_AdvancedFaceRecognitionCS;	
};
  
//=============================================================================
class AdvancedFaceRecognitionCS: public DescriptionCodingEngine
{
friend class AdvancedFaceRecognitionCSInterface;
public:
  ...
  virtual AdvancedFaceRecognitionCSInterfaceABC *GetInterface(void);
...
private:
  virtual ~AdvancedFaceRecognitionCS();

  AdvancedFaceRecognitionCSInterface    m_Interface;
...
#endif //__AdvancedFaceRecognitionCS_H__
