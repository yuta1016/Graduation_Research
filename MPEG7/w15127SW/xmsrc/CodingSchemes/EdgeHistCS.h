...
//
// Applicable File Name:  EdgesHistCS.h
#ifndef __EDGEHISTOGRAMCS_H__
#define __EDGEHISTOGRAMCS_H__
...
//=============================================================================
class EdgeHistogramCSInterfaceABC: public I_InterfaceABC
{
public:
  EdgeHistogramCSInterfaceABC();
  virtual ~EdgeHistogramCSInterfaceABC() {}
...
class EdgeHistogramCS;

//=============================================================================
class EdgeHistogramCSInterface: public EdgeHistogramCSInterfaceABC
{
public:
  EdgeHistogramCSInterface(EdgeHistogramCS *anCS);
  virtual ~EdgeHistogramCSInterface();
...
private:
	EdgeHistogramCS *m_EdgeHistogramCS;	
};


//=============================================================================
class EdgeHistogramCS: public DescriptionCodingEngine
{
friend class EdgeHistogramCSInterface;
public:
  EdgeHistogramCS();
  EdgeHistogramCS(EdgeHistogramDescriptorInterfaceABC
			 *aEdgeHisogram);
 ...
 // IMPLEMENTING A CLASS FACTORY GENERATING THIS OBJECT
  ...
  virtual EdgeHistogramCSInterfaceABC *GetInterface(void);
...
private:
  virtual ~EdgeHistogramCS();

  EdgeHistogramCSInterface m_Interface;
