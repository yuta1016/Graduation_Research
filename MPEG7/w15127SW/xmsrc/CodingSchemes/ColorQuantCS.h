...
//
// Applicable File Name:  ColorQuantCS.h
#ifndef __ColorQuantCS__
#define __ColorQuantCS__
...
//=============================================================================
class ColorQuantizerCSInterfaceABC: public I_InterfaceABC
{
public:
	ColorQuantizerCSInterfaceABC();
	...
	virtual int SetDescriptorInterface(ColorQuantizerDescriptorInterfaceABC
				    *aColorQuantizerDescriptorInterface) = 0;
	virtual int StartEncode() = 0;
	virtual int StartDecode() = 0;
};

class ColorQuantizerCS;

//=============================================================================
class ColorQuantizerCSInterface: public ColorQuantizerCSInterfaceABC
{
public:
	ColorQuantizerCSInterface(ColorQuantizerCS *anCS);
	virtual ~ColorQuantizerCSInterface();
	...
	virtual ColorQuantizerDescriptorInterfaceABC *GetDescriptorInterface(void);
	virtual int SetDescriptorInterface(ColorQuantizerDescriptorInterfaceABC
...
//=============================================================================
class ColorQuantizerCS: public DescriptionCodingEngine
{
friend class ColorQuantizerCSInterface;
public:
	ColorQuantizerCS();
	...
	virtual ColorQuantizerCSInterfaceABC *GetInterface(void);
...
private:
	virtual ~ColorQuantizerCS();

	ColorQuantizerCSInterface m_Interface;
