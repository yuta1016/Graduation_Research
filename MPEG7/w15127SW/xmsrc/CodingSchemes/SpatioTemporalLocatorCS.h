...
//
// Applicable File Name:  SpatioTemporalLocatorCS.h
#ifndef __SpatioTemporalLocatorCS__
#define __SpatioTemporalLocatorCS__
...
//=============================================================================
class SpatioTemporalLocatorCSInterfaceABC: public I_InterfaceABC
{
public:
	SpatioTemporalLocatorCSInterfaceABC();
	virtual ~SpatioTemporalLocatorCSInterfaceABC() {}
	...
	virtual int SetDescriptorInterface(SpatioTemporalLocatorDescriptorInterfaceABC
				    *aSpatioTemporalLocatorDescriptorInterface) = 0;


	virtual RegionLocatorCSInterfaceABC
	  *GetRegionLocatorCSInterface(void) = 0;
	virtual int SetRegionLocatorCSInterface(RegionLocatorCSInterfaceABC
					    *aRegionLocatorCSInterface) = 0;

	virtual TemporalInterpolationCSInterfaceABC
	  *GetTemporalInterpolationCSInterface(void) = 0;
	virtual int SetTemporalInterpolationCSInterface(
	    TemporalInterpolationCSInterfaceABC
	    *aTemporalInterpolationBCSInterface) = 0;
...
class SpatioTemporalLocatorCS;

//=============================================================================
class SpatioTemporalLocatorCSInterface: public SpatioTemporalLocatorCSInterfaceABC
{
public:
	SpatioTemporalLocatorCSInterface(SpatioTemporalLocatorCS *anCS);
	virtual ~SpatioTemporalLocatorCSInterface();
	...
	virtual SpatioTemporalLocatorDescriptorInterfaceABC *GetDescriptorInterface(void);
	virtual int SetDescriptorInterface(SpatioTemporalLocatorDescriptorInterfaceABC
	...
	virtual int SetTemporalInterpolationCSInterface(
          TemporalInterpolationCSInterfaceABC
	  *aTemporalInterpolationBCSInterface) ;

	virtual int StartEncode();
	virtual int StartDecode();

private:
	SpatioTemporalLocatorCS *m_SpatioTemporalLocatorCS;	
};
...
//=============================================================================
class SpatioTemporalLocatorCS: public DescriptionCodingEngine
{
friend class SpatioTemporalLocatorCSInterface;
public:
	...
	virtual SpatioTemporalLocatorCSInterfaceABC *GetInterface(void);
...
private:
	virtual ~SpatioTemporalLocatorCS(); 

	SpatioTemporalLocatorCSInterface m_Interface;
	...
	RegionLocatorCSInterfaceABC *m_RegionLocatorCSInterface;
	TemporalInterpolationCSInterfaceABC 
	  *m_TemporalInterpolationCSInterface;

	unsigned long GetVluimsbf();
	unsigned long PutVluimsbf(unsigned long value);
...
#endif //__SpatioTemporalLocatorCS__
