...
//
// Applicable File Name:  DurationCS.h
#ifndef __DurationCS__
#define __DurationCS__
...
//=============================================================================
class DurationCSInterfaceABC: public I_InterfaceABC
{
public:
	DurationCSInterfaceABC();
	virtual ~DurationCSInterfaceABC() {}
	...
	virtual int SetDescriptorInterface(DurationDescriptorInterfaceABC
				    *aDurationDescriptorInterface) = 0;
...
//=============================================================================
class DurationCSInterface: public DurationCSInterfaceABC
{
public:
	DurationCSInterface(DurationCS *anCS);
	virtual ~DurationCSInterface();
	...
	virtual DurationDescriptorInterfaceABC *GetDescriptorInterface(void);
	virtual int SetDescriptorInterface(DurationDescriptorInterfaceABC
...
//=============================================================================
class DurationCS: public DescriptionCodingEngine
{
public:
	DurationCS();
	virtual ~DurationCS();
	...
	virtual DurationCSInterfaceABC *GetInterface(void);
...
private:
	...
	DurationCSInterface m_Interface;
	...
	DurationDescriptorInterfaceABC *m_DurationDescriptorInterface;
};

};

#endif //__DurationCS__
