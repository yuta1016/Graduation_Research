...
//
// Applicable File Name:  FaceRecognitionCS.h
#ifndef __FaceRecognitionCS__
#define __FaceRecognitionCS__
...
//=============================================================================
class FaceRecognitionCSInterfaceABC: public I_InterfaceABC
{
public:
	FaceRecognitionCSInterfaceABC();
	virtual ~FaceRecognitionCSInterfaceABC() {}
...
class FaceRecognitionCS;

//=============================================================================
class FaceRecognitionCSInterface: public FaceRecognitionCSInterfaceABC
{
public:
	FaceRecognitionCSInterface(FaceRecognitionCS *anCS);
	virtual ~FaceRecognitionCSInterface();
	...
	virtual FaceRecognitionDescriptorInterfaceABC *GetDescriptorInterface(void);
	virtual int SetDescriptorInterface(FaceRecognitionDescriptorInterfaceABC
...
private:
	FaceRecognitionCS *m_FaceRecognitionCS;	
};

//=============================================================================
class FaceRecognitionCS: public DescriptionCodingEngine
{
friend class FaceRecognitionCSInterface;
public:
	FaceRecognitionCS();
	...
	virtual FaceRecognitionCSInterfaceABC *GetInterface(void);
...
private:
	virtual ~FaceRecognitionCS();

	FaceRecognitionCSInterface    m_Interface;
