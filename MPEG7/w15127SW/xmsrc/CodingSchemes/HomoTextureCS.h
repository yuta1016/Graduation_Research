...
//
// Applicable File Name:  HomoTextureCS.h
#ifndef __HomogeneousTextureCS__
#define __HomogeneousTextureCS__
...
//=============================================================================
class HomogeneousTextureCSInterfaceABC: public I_InterfaceABC
{
public:
  HomogeneousTextureCSInterfaceABC();
  virtual ~HomogeneousTextureCSInterfaceABC() {}
  ...
  virtual int SetDescriptorInterface(HomogeneousTextureDescriptorInterfaceABC
				     *aHomogeneousTextureDescriptorInterfac) = 0;

  virtual int StartEncode() = 0;
  virtual int StartDecode() = 0;
};

class HomogeneousTextureCS;

//=============================================================================
class HomogeneousTextureCSInterface: public HomogeneousTextureCSInterfaceABC
{
public:
  HomogeneousTextureCSInterface(HomogeneousTextureCS *anCS);
  virtual ~HomogeneousTextureCSInterface();
  ...
  virtual int SetDescriptorInterface(HomogeneousTextureDescriptorInterfaceABC
				     *aHomogeneousTextureDescriptorInterfac);

  virtual int StartEncode();
  virtual int StartDecode();

private:
	HomogeneousTextureCS *m_HomogeneousTextureCS;	
};

//=============================================================================
class HomogeneousTextureCS: public DescriptionCodingEngine
{
friend class HomogeneousTextureCSInterface;
public:
 HomogeneousTextureCS();
 HomogeneousTextureCS(HomogeneousTextureDescriptorInterfaceABC
	     *HomogeneousTexture);
 ...
 virtual HomogeneousTextureCSInterfaceABC *GetInterface(void);
...
private:
 virtual ~HomogeneousTextureCS();

 HomogeneousTextureCSInterface m_Interface;
...
#endif //__HomogeneousTextureCS__
