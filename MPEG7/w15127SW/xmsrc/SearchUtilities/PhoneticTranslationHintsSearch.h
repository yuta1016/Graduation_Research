////////////////////////////////////////////////////////////////////////
//
// PhoneticTranslationHintsSearch.h
//
...
#ifndef __PHONETIC_TRANSLATION_HINTS_SEARCH_H__
#define __PHONETIC_TRANSLATION_HINTS_SEARCH_H__
...
class PhoneticTranslationHintsSearchTool;

//=============================================================================
class PhoneticTranslationHintsSearchInterfaceABC: public I_SearchInterfaceABC
{
public:
	PhoneticTranslationHintsSearchInterfaceABC();
	virtual ~PhoneticTranslationHintsSearchInterfaceABC() {};
...
//=============================================================================
class PhoneticTranslationHintsSearchInterface:public PhoneticTranslationHintsSearchInterfaceABC
{
public:
	PhoneticTranslationHintsSearchInterface(PhoneticTranslationHintsSearchTool* aTool);
	virtual ~PhoneticTranslationHintsSearchInterface();
...
private:
	PhoneticTranslationHintsSearchTool *m_SearchTool;
};

//=============================================================================
class PhoneticTranslationHintsSearchTool: public Search
{
friend class PhoneticTranslationHintsSearchInterface;
public:
	PhoneticTranslationHintsSearchTool();
	PhoneticTranslationHintsSearchTool(GenericDSInterfaceABC *aDescription);

	virtual const UUID& GetObjectID(void);
	virtual const char *GetName(void);
	virtual PhoneticTranslationHintsSearchInterfaceABC *GetInterface(void);
	...
	static const char * myName;
private:
	virtual ~PhoneticTranslationHintsSearchTool();

	PhoneticTranslationHintsSearchInterface m_Interface;
...
#endif //__PHONETIC_TRANSLATION_HINTS_SEARCH_H__
