...
unsigned char *rec[3];
{
  ...
  calcSNR1(org[0]+offs,rec[0]+offs,width2,w,h,&v,&e);
  psnr_y =  10.0*log10(255*255/e);
  fprintf(statfile,"Y: variance=%4.4g, MSE=%3.3g (PSNR_Y: %3.3g dB), SNR=%3.3g dB\n",
    v, e, 10.0*log10(255.0*255.0/e), 10.0*log10(v/e));
  ...
  calcSNR1(org[1]+offs,rec[1]+offs,chrom_width2,w,h,&v,&e);
  psnr_u =  10.0*log10(255*255/e);
  fprintf(statfile,"U: variance=%4.4g, MSE=%3.3g (PSNR_U: %3.3g dB), SNR=%3.3g dB\n",
    v, e, 10.0*log10(255.0*255.0/e), 10.0*log10(v/e));

  calcSNR1(org[2]+offs,rec[2]+offs,chrom_width2,w,h,&v,&e);
  psnr_v =  10.0*log10(255*255/e);
  fprintf(statfile,"V: variance=%4.4g, MSE=%3.3g (PSNR_V: %3.3g dB), SNR=%3.3g dB\n",
    v, e, 10.0*log10(255.0*255.0/e), 10.0*log10(v/e));
    
  print_psnr_stats(framenum, psnr_y, psnr_u, psnr_v);  
