...
//
// Applicable File Name:  SegmentRelGraphCAppl.h
//
#ifndef __SEGMENTRELGRAPH_CLIENT__
#define __SEGMENTRELGRAPH_CLIENT__
...
//=============================================================================
class SegmentRelGraphClient: public ClientApplication
{
public:
	SegmentRelGraphClient();
	virtual ~SegmentRelGraphClient();
...
#endif //__SEGMENTRELGRAPH_CLIENT__
