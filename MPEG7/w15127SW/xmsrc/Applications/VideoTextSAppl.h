...
//
// Applicable File Name:  VideoTextSAppl.h
//
#ifndef __VIDEOTEXT_SERVER__
#define __VIDEOTEXT_SERVER__
...
//=============================================================================
class VideoTextServer : public ServerApplication
{
public:
	VideoTextServer();
	virtual ~VideoTextServer();
