...
//
// Applicable File Name:  3DShapeSpectrumCAppl.h
//
#ifndef __SHAPE_SPECTRUM_CLIENT__
#define __SHAPE_SPECTRUM_CLIENT__
...
//=============================================================================
class ShapeSpectrumClient: public ClientApplication
{
public:
	ShapeSpectrumClient();
	virtual ~ShapeSpectrumClient();
...
private:
	...
	ShapeSpectrumDescriptor **DBDescription;
};
};

#endif //__SHAPE_SPECTRUM_CLIENT__
