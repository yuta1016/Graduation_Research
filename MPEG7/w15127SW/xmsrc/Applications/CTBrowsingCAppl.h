...
//
// Applicable File Name:  CTBrowsingCAppl.h
//

#ifndef __CTBROWSINGCLIENT__
#define __CTBROWSINGCLIENT__
...
//=============================================================================
class CTBrowsingClient: public ClientApplication
{
public:
  CTBrowsingClient();
  virtual ~CTBrowsingClient();
...
private:
  ...
  CTBrowsingDescriptor **DBDescription;
};
};

#endif //__CTBROWSINGCLIENT__
