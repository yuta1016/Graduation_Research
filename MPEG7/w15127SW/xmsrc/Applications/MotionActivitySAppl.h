...
//
// Applicable File Name:  MotionActivitySAppl.h
//
#ifndef __MOTION_ACTIVITY_SERVER__
#define __MOTION_ACTIVITY_SERVER__
...
//=============================================================================
class MotionActivityServer: public ServerApplication
{
public:
	MotionActivityServer();
	virtual ~MotionActivityServer();
