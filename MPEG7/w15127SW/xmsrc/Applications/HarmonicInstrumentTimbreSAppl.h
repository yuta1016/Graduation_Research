...
//
// Applicable File Name:  HarmonicInstrumentTimbreSAppl.h
//
#ifndef __HARMONIC_INSTRUMENT_TIMBRE_SERVER__
#define __HARMONIC_INSTRUMENT_TIMBRE_SERVER__
...
class HarmonicInstrumentTimbreServer: public ServerApplication
{
public:
  // Null constructor
  HarmonicInstrumentTimbreServer();

  // Destructor
  virtual ~HarmonicInstrumentTimbreServer();
...
#endif //__HARMONIC_INSTRUMENT_TIMBRE_SERVER__
