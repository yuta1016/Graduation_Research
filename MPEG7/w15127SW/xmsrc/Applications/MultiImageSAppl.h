...
//
// Applicable File Name:  MultiImageSAppl.h
//
#ifndef __MULTIIMAGESERVER__
#define __MULTIIMAGESERVER__
...
class MultiImageServer: public ServerApplication
{
public:
  // Null constructor
  MultiImageServer();
