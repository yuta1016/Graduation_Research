...
//
// Applicable File Name:  ContourShapeSAppl.cpp
//
///////////////////////////////////////////////////////////////////////////////
...
const UUID ContourShapeServer::myID = UUID("");
const char *ContourShapeServer::myName = "Contour-Based Shape Server";

//=============================================================================
ContourShapeServer::ContourShapeServer()
{
}
...
//----------------------------------------------------------------------------
unsigned long ContourShapeServer::Open()
{
...
//----------------------------------------------------------------------------
unsigned long ContourShapeServer::Start(char *ListFile, char *Bitstream)
{
	int CodingMode;
	...
	theContourShapeCS = new
	  ContourShapeCS(theContourShapeDescriptorInterface);
	...
	while (1) {
	  ...
	  {
#ifdef USEXML
	    theContourShapeDescriptorInterface->ExportDDL(theCollectionInterface);
#endif // USEXML
	  }
	}
...
//----------------------------------------------------------------------------
unsigned long ContourShapeServer::Stop()
{
//	fprintf(stderr,"Not Implemented\n");
	return 0;
}
//----------------------------------------------------------------------------
unsigned long ContourShapeServer::Close()
{
//	fprintf(stderr,"Not Implemented\n");
	return 0;
}
...
//----------------------------------------------------------------------------
const UUID& ContourShapeServer::GetObjectID(void)
{ return myID; }

//----------------------------------------------------------------------------
const char *ContourShapeServer::GetName(void)
{ return myName; }
