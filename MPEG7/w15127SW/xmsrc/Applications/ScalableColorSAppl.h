...
//
#ifndef __SCAL_COLOR_SERVER__
#define __SCAL_COLOR_SERVER__
...
//=============================================================================
class ScalableColorServer: public ServerApplication
{
public:
	ScalableColorServer();
	virtual ~ScalableColorServer();
