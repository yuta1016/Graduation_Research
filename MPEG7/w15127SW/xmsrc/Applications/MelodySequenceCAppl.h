...
//
// Applicable File Name:  MelodySequenceCAppl.h
//

#ifndef __MELODYSEQUENCECLIENT__
#define __MELODYSEQUENCECLIENT__
...
//=============================================================================
class MelodySequenceClient: public ClientApplication
{
public:
  MelodySequenceClient();
  virtual ~MelodySequenceClient();
...
#endif //__MELODYSEQUENCECLIENT__
