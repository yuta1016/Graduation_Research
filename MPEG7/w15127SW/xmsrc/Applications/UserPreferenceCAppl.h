...
#ifndef __USER_PREFERENCE_CLIENT__
#define __USER_PREFERENCE_CLIENT__
...
//=============================================================================
class UserPreferenceClient: public ClientApplication
{
public:
	UserPreferenceClient();
	virtual ~UserPreferenceClient();
...
#endif //__USER_PREFERENCE_CLIENT__
