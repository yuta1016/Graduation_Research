...
#ifndef __EXTENDED_TEXTUAL_TYPE_CLIENT__
#define __EXTENDED_TEXTUAL_TYPE_CLIENT__
...
//=============================================================================
class ExtendedTextualTypeClient: public ClientApplication
{
public:
	ExtendedTextualTypeClient();
	virtual ~ExtendedTextualTypeClient();
...
#endif //__EXTENDED_TEXTUAL_TYPE_CLIENT__
