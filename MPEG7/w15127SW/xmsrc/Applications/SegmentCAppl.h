...
//
// Applicable File Name:  SegmentCAppl.h
//
#ifndef __SEGMENT_CLIENT__
#define __SEGMENT_CLIENT__
...
//=============================================================================
class SegmentClient: public ClientApplication
{
public:
	SegmentClient();
	virtual ~SegmentClient();
