...
//
// Applicable File Name:  RegionShapeCAppl.h
//
#ifndef __REGIONSHAPE_CLIENT__
#define __REGIONSHAPE_CLIENT__
...
//=============================================================================
class RegionShapeClient: public ClientApplication
{
public:
	RegionShapeClient();
	virtual ~RegionShapeClient();
...
private:
	...
	RegionShapeDescriptor **DBRegionShapeDescription;
};
};

#endif //__REGIONSHAPE_CLIENT__
