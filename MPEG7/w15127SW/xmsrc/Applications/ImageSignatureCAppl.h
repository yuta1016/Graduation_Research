...
//
// Applicable File Name:  ImageSignatureCAppl.h
//
///////////////////////////////////////////////////////////////////////////////

#ifndef __IMAGE_SIGNATURE_CLIENT__
#define __IMAGE_SIGNATURE_CLIENT__
...
//=============================================================================
class ImageSignatureClient: public ClientApplication
{
public:
        ImageSignatureClient();
        virtual ~ImageSignatureClient();
...
private:
	...
	ImageSignatureDescriptor **DBImageSignatureDescription;
};
};

#endif //__IMAGE_SIGNATURE_SERVER__
