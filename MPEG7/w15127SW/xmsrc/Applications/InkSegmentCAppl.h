...
//
// Applicable File Name:  InkSegmentCAppl.h
//
#ifndef __INKSEGMENT_CLIENT__
#define __INKSEGMENT_CLIENT__
...
//=============================================================================
class InkSegmentClient: public ClientApplication
{
public:
	InkSegmentClient();
	virtual ~InkSegmentClient();

	virtual unsigned long Open(char *MediaFile, char *DescriptionFile);
	//sth MediaFile should be database
...
private:
	...
	GenericDS* m_theInkSegmentDS;
	GenericDS* m_theDescriptionDS;
