...
//
// Applicable File Name:  SeqSummaryKeywordsSAppl.h
//
#ifndef __SEQSUMMARYKEYWORDS_SERVER__
#define __SEQSUMMARYKEYWORDS_SERVER__
...
//=============================================================================
class SeqSummaryKeywordsServer : public ServerApplication
{
public:
	SeqSummaryKeywordsServer();
	virtual ~SeqSummaryKeywordsServer();
