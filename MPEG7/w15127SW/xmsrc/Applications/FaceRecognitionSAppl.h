...
//
// Applicable File Name:  FaceRecognitionSAppl.h
//
#ifndef __FACE_RECOGNITION_SERVER__
#define __FACE_RECOGNITION_SERVER__
...
//=============================================================================
class FaceRecognitionServer: public ServerApplication
{
public:
	FaceRecognitionServer();
	virtual ~FaceRecognitionServer();
...
#endif //__FACE_RECOGNITION_SERVER__
