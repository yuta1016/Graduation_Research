...
//
// Applicable File Name:  RegionShapeSAppl.h
//
#ifndef __REGIONSHAPE_SERVER__
#define __REGIONSHAPE_SERVER__
...
//=============================================================================
class RegionShapeServer: public ServerApplication
{
public:
	RegionShapeServer();
	virtual ~RegionShapeServer();
