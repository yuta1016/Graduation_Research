...
//
// Applicable File Name:  AudioSpectralFlatnessCAppl.cpp
//
...
const UUID AudioSpectralFlatnessClient::myID = UUID("");
const char *AudioSpectralFlatnessClient::myName = "AudioSpectralFlatnessClient";

//=============================================================================
AudioSpectralFlatnessClient::AudioSpectralFlatnessClient():
RamDB(),
NoOfElements(0),
DBDescription(0)
{
...
//----------------------------------------------------------------------------
unsigned long AudioSpectralFlatnessClient::Open(char *ListFile, char *DDLFile)
{
  DDLFilename = DDLFile;
  ...
  try{
    ...
    fprintf(stderr,"AudioSpectralFlatnessClient::Open: Allocation error\n");
    return(1);
  }
  ...
  try{
    ...
    fprintf(stderr,"AudioSpectralFlatnessClient::Open: Allocation error2\n");
    return(1);
  }
...
//----------------------------------------------------------------------------
unsigned long AudioSpectralFlatnessClient::Start(char *Query,int NoOfMatches)
{
  // Check data is sane
  assert(Query       != NULL);
  ...
  AudioSpectralFlatnessSearchTool*         theSearchTool              = NULL;
  AudioSpectralFlatnessSearchInterfaceABC* theSearchInterface         = NULL;


  try{
    // Create search tool
    theSearchTool = new AudioSpectralFlatnessSearchTool(theDocumentInterfaceABC );
    ...
    fprintf(stderr,"AudioSpectralFlatnessClient::Start: Allocation error1\n");
    return(1);
  }
...
//----------------------------------------------------------------------------
unsigned long AudioSpectralFlatnessClient::Stop()
{
  // fprintf(stderr,"AudioSpectralFlatnessClient::Stop: Not Implemented");
  return 0;
}


//----------------------------------------------------------------------------
unsigned long AudioSpectralFlatnessClient::Close()
{
  // Free memories
  RamDB.FreeDatabase();
...
//----------------------------------------------------------------------------
const UUID& AudioSpectralFlatnessClient::GetObjectID(void)
{ return myID; }

//----------------------------------------------------------------------------
const char *AudioSpectralFlatnessClient::GetName(void)
{ return myName; }
