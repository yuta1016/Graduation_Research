...
#ifndef __MEDIA_META_CLIENT__
#define __MEDIA_META_CLIENT__
...
//=============================================================================
class MediaMetaClient: public ClientApplication
{
public:
	MediaMetaClient();
	virtual ~MediaMetaClient();
