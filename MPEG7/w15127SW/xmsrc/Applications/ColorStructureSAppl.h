...
#ifndef __COLOR_STRUCT_HIST_SERVER__
#define __COLOR_STRUCT_HIST_SERVER__
...
class ColorStructureServer: public ServerApplication
{
public:
	// Null constructor
	ColorStructureServer();

	// Destructor
	virtual ~ColorStructureServer();
...
#endif //__COLOR_STRUCT_HIST_SERVER__
