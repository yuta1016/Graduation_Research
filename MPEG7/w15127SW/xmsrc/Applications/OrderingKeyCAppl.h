...
#ifndef __ORDERINGKEY_CLIENT__
#define __ORDERINGKEY_CLIENT__
...
//=============================================================================
class OrderingKeyClient: public ClientApplication
{
public:
  OrderingKeyClient();
  virtual ~OrderingKeyClient();
