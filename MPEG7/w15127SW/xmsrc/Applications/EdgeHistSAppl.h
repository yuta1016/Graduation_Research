...
//
// Applicable File Name:  EdgeHistSAppl.h
//
#ifndef __EDGEHISTOGRAMSERVER__
#define __EDGEHISTOGRAMSERVER__
...
class EdgeHistogramServer: public ServerApplication
{
public:
  // Null constructor
  EdgeHistogramServer();
