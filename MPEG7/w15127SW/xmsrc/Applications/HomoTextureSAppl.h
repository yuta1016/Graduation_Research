...
//
// Applicable File Name:  HomoTextureSAppl.h
//

#ifndef _HOMO_TEXTURE_SAPPL_H_
#define _HOMO_TEXTURE_SAPPL_H_
...
// homoeneous texture type. 
// 

class HomogeneousTextureServer: public ServerApplication
{
public:
  // Null constructor
  HomogeneousTextureServer();

  // Destructor
  virtual ~HomogeneousTextureServer();
