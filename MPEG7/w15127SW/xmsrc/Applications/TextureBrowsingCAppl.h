...
//
// Applicable File Name:  TextureBrowsingCAppl.h
//
#ifndef __TEXTURE_BROWSING_CLIENT__
#define __TEXTURE_BROWSING_CLIENT__
...
//=============================================================================
class TextureBrowsingClient: public ClientApplication
{
public:
  TextureBrowsingClient();
  virtual ~TextureBrowsingClient();
...
private:
  ...
  TextureBrowsingDescriptor **DBDescription;
};
};

#endif //__TEXTURE_BROWSING_CLIENT__
