...
//
// Applicable File Name:  GoFGoPColorCAppl.h
//

#ifndef __GOFGOPCOLOR_CLIENT__
#define __GOFGOPCOLOR_CLIENT__
...
//=============================================================================
class GoFGoPColorClient: public ClientApplication
{
public:
  GoFGoPColorClient();
  virtual ~GoFGoPColorClient();
...
private:
  ...
  GoFGoPColorDescriptor **DBDescription;
};
};

#endif //__GOFGOPCOLOR_CLIENT__
