...
//
// Applicable File Name:  StateMemberCAppl.h
//

#ifndef __STATEMEMBER_CLIENT__
#define __STATEMEMBER_CLIENT__
...
//=============================================================================
class StateMemberClient: public ClientApplication
{
public:
  StateMemberClient();
  virtual ~StateMemberClient();
