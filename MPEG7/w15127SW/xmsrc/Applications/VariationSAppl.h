...
//
// Applicable File Name:  VariationSAppl.h
//
#ifndef __VARIATION_SERVER__
#define __VARIATION_SERVER__
...
//=============================================================================
class VariationServer: public ServerApplication
{
public:
	VariationServer();
	virtual ~VariationServer();
