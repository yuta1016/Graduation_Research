...
//
// Applicable File Name:  MosaicCAppl.h
//
#ifndef __MOSAIC_CLIENT__
#define __MOSAIC_CLIENT__
...
//=============================================================================
class MosaicClient: public ClientApplication
{
public:
	MosaicClient();
	virtual ~MosaicClient();
