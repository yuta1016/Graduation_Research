...
//
// Applicable File Name:  ColorLayoutSAppl.h
//
#ifndef __COLOR_LAYOUT_SERVER__
#define __COLOR_LAYOUT_SERVER__
...
//=============================================================================
class ColorLayoutServer: public ServerApplication
{
public:
	ColorLayoutServer();
	virtual ~ColorLayoutServer();
