...
//
// Applicable File Name:  CameraMotionSAppl.h
//

#ifndef __CAMERA_MOTION_SERVER__
#define __CAMERA_MOTION_SERVER__
...
//=============================================================================
class CameraMotionServer: public ServerApplication
{
public:
	CameraMotionServer();
	virtual ~CameraMotionServer();
