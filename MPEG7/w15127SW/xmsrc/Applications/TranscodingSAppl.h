...
//
// Applicable File Name:  TranscodingSAppl.h
//
#ifndef __TRANSCODING_SERVER__
#define __TRANSCODING_SERVER__
...
//=============================================================================
class TranscodingServer : public ServerApplication
{
public:
	TranscodingServer();
	virtual ~TranscodingServer();
