...
//
// Applicable File Name:  PercussiveInstrumentTimbreSAppl.h
//
#ifndef __PERCUSSIVE_INSTRUMENT_TIMBRE_SERVER__
#define __PERCUSSIVE_INSTRUMENT_TIMBRE_SERVER__
...
class PercussiveInstrumentTimbreServer: public ServerApplication
{
public:
  // Null constructor
  PercussiveInstrumentTimbreServer();

  // Destructor
  virtual ~PercussiveInstrumentTimbreServer();
...
#endif //__PERCUSSIVE_INSTRUMENT_TIMBRE_SERVER__
