...
//
// Applicable File Name:  SummarizationCAppl.h
//
#ifndef __SUMMARIZATION_CLIENT__
#define __SUMMARIZATION_CLIENT__
...
//=============================================================================
class SummarizationClient: public ClientApplication
{
public:
	SummarizationClient();
	virtual ~SummarizationClient();
...
#endif //__SUMMARIZATION_CLIENT__
