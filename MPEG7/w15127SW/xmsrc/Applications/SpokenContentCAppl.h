...
//
// Applicable File Name:  SpokenContentCAppl.h
//
#ifndef __SPOKENCONTENT_TYPE_CLIENT__
#define __SPOKENCONTENT_TYPE_CLIENT__
...
//=============================================================================
class SpokenContentClient: public ClientApplication
{
public:
	SpokenContentClient();
	virtual ~SpokenContentClient();
...
private:
	...
	int NoOfElements;
  	...
  	SpokenContentDescriptor **DBSpokenContentDescription;
};
};

//#endif // USEXML
#endif //__SPOKENCONTENT_TYPE_CLIENT__
