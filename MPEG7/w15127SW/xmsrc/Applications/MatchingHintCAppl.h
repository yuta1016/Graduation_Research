...
#ifndef __MATCHING_HINT_CLIENT__
#define __MATCHING_HINT_CLIENT__
...
//=============================================================================
class MatchingHintClient: public ClientApplication
{
public:
	MatchingHintClient();
	virtual ~MatchingHintClient();
...
#endif //__USER_PREFERENCE_CLIENT_
