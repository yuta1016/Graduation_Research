...
//
// Applicable File Name:  SequentialSummarySAppl.h
//
#ifndef __SEQUENTIALSUMMARYSERVER__
#define __SEQUENTIALSUMMARYSERVER__
...
class SequentialSummaryServer: public ServerApplication
{
public:
  // Null constructor
  SequentialSummaryServer();

  // Destructor
  virtual ~SequentialSummaryServer();
...
#endif //__SEQUENTIALSUMMARYSERVER__
