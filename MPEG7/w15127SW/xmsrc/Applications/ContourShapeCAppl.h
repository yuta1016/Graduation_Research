...
#ifndef __CONTOUR_SHAPE_CLIENT__
#define __CONTOUR_SHAPE_CLIENT__
...
//=============================================================================
class ContourShapeClient: public ClientApplication
{
public:
        ContourShapeClient();
        virtual ~ContourShapeClient();
...
#endif //__CONTOUR_SHAPE_SERVER__
