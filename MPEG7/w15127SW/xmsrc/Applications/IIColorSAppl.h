...
//
// Applicable File Name:  IIColorSAppl.h
//
#ifndef __IICOLORSERVER__
#define __IICOLORSERVER__
...
class IIColorServer: public ServerApplication
{
public:
  // Null constructor
  IIColorServer();
