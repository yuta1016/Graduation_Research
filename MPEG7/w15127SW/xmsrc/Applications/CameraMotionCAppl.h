...
#ifndef __CAMERA_MOTION_CLIENT__
#define __CAMERA_MOTION_CLIENT__
...
//=============================================================================
class CameraMotionClient: public ClientApplication
{
public:
	CameraMotionClient();

	virtual ~CameraMotionClient();
...
private:
	...
	int NoOfElements;
	CameraMotionDescriptor **DBDescription;
...
#endif //__CAMERA_MOTION_CLIENT__
