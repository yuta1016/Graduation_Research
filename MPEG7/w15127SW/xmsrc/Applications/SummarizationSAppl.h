...
//
// Applicable File Name:  SummarizationSAppl.h
//
#ifndef __SUMMARIZATION_SERVER__
#define __SUMMARIZATION_SERVER__
...
//=============================================================================
class SummarizationServer : public ServerApplication
{
public:
	SummarizationServer();
	virtual ~SummarizationServer();
