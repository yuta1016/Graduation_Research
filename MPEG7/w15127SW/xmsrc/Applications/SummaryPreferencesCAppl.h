...
//////////////////////////////////////////////////////////////////////////////////
/********************************
 * SummaryPreferencesCAppl.h    *
 ********************************/


#ifndef __UP_SEGMENT_FILTER_CLIENT__
#define __UP_SEGMENT_FILTER_CLIENT__
...
//=============================================================================
class SummaryPreferencesClient: public ClientApplication
{
public:
	SummaryPreferencesClient();
	virtual ~SummaryPreferencesClient();
...
#endif //__UP_SEGMENT_FILTER_CLIENT__
