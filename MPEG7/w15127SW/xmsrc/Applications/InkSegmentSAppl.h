...
//
// Applicable File Name:  InkSegmentSAppl.h
//
#ifndef __INKSEGMENT_SERVER__
#define __INKSEGMENT_SERVER__
...
//=============================================================================
class InkSegmentServer: public ServerApplication
{
public:
	InkSegmentServer();
	virtual ~InkSegmentServer();
