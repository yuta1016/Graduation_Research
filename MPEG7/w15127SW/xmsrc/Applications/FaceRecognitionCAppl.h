...
//
// Applicable File Name:  FaceRecognitionCAppl.h
//
#ifndef __FACE_RECOGNITION_CLIENT__
#define __FACE_RECOGNITION_CLIENT__
...
//=============================================================================
class FaceRecognitionClient: public ClientApplication
{
public:
	FaceRecognitionClient();
	virtual ~FaceRecognitionClient();
...
private:
	...
	FaceRecognitionDescriptor  **DBDescription;

};
};

#endif //__FACE_RECOGNITION_CLIENT__
