...
//
// Applicable File Name:  CTBrowsingSAppl.cpp
//
...
const UUID CTBrowsingServer::myID = UUID("");
const char *CTBrowsingServer::myName = "CTBrowsingServer";

//=============================================================================
CTBrowsingServer::CTBrowsingServer()
{
}
...
unsigned long CTBrowsingServer::Start(char *ListFile, char *Bitstream)
{
  ...
  try{
    ...
    if (CodingMode == 2) { // Binary coding
      ...
      theBinCS = new CTBrowsingCS(theDescriptorInterface);
    ...
    fprintf(stderr,"CTBrowsingServer::Start: Allocation error\n");
    return(1);
  }
...
//----------------------------------------------------------------------------
unsigned long CTBrowsingServer::Stop()
{
  return(0);
}
...
//----------------------------------------------------------------------------
unsigned long CTBrowsingServer::Open()
{
  return(0);
}
...
//----------------------------------------------------------------------------
unsigned long CTBrowsingServer::Close()
{
  return(0);
}
...
//----------------------------------------------------------------------------
const UUID& CTBrowsingServer::GetObjectID(void)
{ 
  return(myID);
}

//----------------------------------------------------------------------------
const char *CTBrowsingServer::GetName(void)
{ 
  return(myName); 
}
