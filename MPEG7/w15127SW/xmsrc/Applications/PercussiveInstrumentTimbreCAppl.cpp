...
//
// Applicable File Name:  PercussiveInstrumentTimbreCAppl.cpp
//
...
const UUID PercussiveInstrumentTimbreClient::myID = UUID("");
const char *PercussiveInstrumentTimbreClient::myName = "PercussiveInstrumentTimbreClient";

//=============================================================================
PercussiveInstrumentTimbreClient::PercussiveInstrumentTimbreClient():
RamDB(),
NoOfElements(0),
DBDescription(0)
{
...
//----------------------------------------------------------------------------
unsigned long PercussiveInstrumentTimbreClient::Open(char *ListFile, char *Bitstream)
{
  ...
  PercussiveInstrumentTimbreDescriptorInterfaceABC* theDescriptorInterface = NULL;
  ...
  PercussiveInstrumentTimbreCS*                     theBinCS               = NULL;
  PercussiveInstrumentTimbreCSInterfaceABC*         theBinCSInterface      = NULL;
  ...
  try{
    ...
    if (CodingMode == 2) { // Binary coding
      ...
      theBinCS = new PercussiveInstrumentTimbreCS();
    ...
    fprintf(stderr,"PercussiveInstrumentTimbreClient::Open: Allocation error\n");
    return(1);
  }
  ...
  try{
    ...
    DBDescription = new PercussiveInstrumentTimbreDescriptor*[NoOfElements];

    // Loop over the entries
    for(int ientry=0;ientry<NoOfElements;ientry++) {

      // Read the binary in
      DBDescription[ientry] = new PercussiveInstrumentTimbreDescriptor();
    ...
    fprintf(stderr,"PercussiveInstrumentTimbreClient::Open: Allocation error2\n");
    return(1);
  }
...
//----------------------------------------------------------------------------
unsigned long PercussiveInstrumentTimbreClient::Start(char *Query,int NoOfMatches)
{
  // Check data is sane
  assert(Query       != NULL);
  ...
  PercussiveInstrumentTimbreDescriptorInterfaceABC* theDescriptorInterface = NULL;
  PercussiveInstrumentTimbreDescriptorInterfaceABC* DBDescriptorInterface  = NULL;

  // Set up the extraction tool which will be needed for the query
  PercussiveInstrumentTimbreExtractionTool*         theExtractionTool      = NULL;
  PercussiveInstrumentTimbreExtractionInterfaceABC* theExtractionInterface = NULL;

  // Set up the search tool
  PercussiveInstrumentTimbreSearchTool*         theSearchTool              = NULL;
  PercussiveInstrumentTimbreSearchInterfaceABC* theSearchInterface         = NULL;
  ...
  try{
    ...
    theExtractionTool = new PercussiveInstrumentTimbreExtractionTool(NULL);
    ...
    // Create search tool
    theSearchTool = new PercussiveInstrumentTimbreSearchTool(theDescriptorInterface);

    // Obtain the search tool interface
    theSearchInterface=theSearchTool->GetInterface();
  }
  catch(...) {
    fprintf(stderr,"PercussiveInstrumentTimbreClient::Start: Allocation error1\n");
    return(1);
  }
...
//----------------------------------------------------------------------------
unsigned long PercussiveInstrumentTimbreClient::Stop()
{
  // fprintf(stderr,"PercussiveInstrumentTimbreClient::Stop: Not Implemented");
  return 0;
}
//----------------------------------------------------------------------------
unsigned long PercussiveInstrumentTimbreClient::Close()
{
  // Free memories
  RamDB.FreeDatabase();
  {
...
//----------------------------------------------------------------------------
const UUID& PercussiveInstrumentTimbreClient::GetObjectID(void)
{ return myID; }

//----------------------------------------------------------------------------
const char *PercussiveInstrumentTimbreClient::GetName(void)
{ return myName; }
