...
//
// Applicable File Name:  VideoEditingSAppl.h
//
#ifndef __VIDEOEDITING_SERVER__
#define __VIDEOEDITING_SERVER__
...
//=============================================================================
class VideoEditingServer : public ServerApplication
{
public:
	VideoEditingServer();
	virtual ~VideoEditingServer();
