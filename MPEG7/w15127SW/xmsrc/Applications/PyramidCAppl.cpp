...
//
// Applicable File Name:  PyramidCAppl.cpp
//
...
const UUID PyramidClient::myID = UUID("");
const char *PyramidClient::myName = "PyramidClient";

//=============================================================================
PyramidClient::PyramidClient():
RamDB(),
NoOfElements(0),
DBDescription(0)
{
...
//----------------------------------------------------------------------------
unsigned long PyramidClient::Open(char *ListFile, char *DDLFile)
{
  ...
  // This sets up the pyramid descriptor interface
  ...
  try{
    ...
    fprintf(stderr,"PyramidClient::Open: Allocation error\n");
    return(1);
  }
  ...
  try{
    ...
    fprintf(stderr,"PyramidClient::Open: Allocation error2\n");
    return(1);
  }
...
//----------------------------------------------------------------------------
unsigned long PyramidClient::Start(char *Query,int NoOfMatches)
{
  // Check data is sane
  assert(Query       != NULL);
  ...
  PyramidSearchTool*         theSearchTool              = NULL;
  PyramidSearchInterfaceABC* theSearchInterface         = NULL;
  ...
  try {  
    ...
    // Create search tool
    theSearchTool = new PyramidSearchTool(theDescriptionInterface);
    ...
    fprintf(stderr,"PyramidClient::Start: Allocation error1\n");
    return(1);
  }
...
//----------------------------------------------------------------------------
unsigned long PyramidClient::Stop()
{
  // fprintf(stderr,"PyramidClient::Stop: Not Implemented");
  return 0;
}
//----------------------------------------------------------------------------
unsigned long PyramidClient::Close()
{
  // Free memories
  RamDB.FreeDatabase();
...
//----------------------------------------------------------------------------
const UUID& PyramidClient::GetObjectID(void)
{ return myID; }

//----------------------------------------------------------------------------
const char *PyramidClient::GetName(void)
{ return myName; }
