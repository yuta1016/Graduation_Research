...
//
// Applicable File Name:  GraphicalCSCAppl.h
//

#ifndef __GRAPHICALCS_CLIENT__
#define __GRAPHICALCS_CLIENT__
...
//=============================================================================
class GraphicalCSClient: public ClientApplication
{
public:
  GraphicalCSClient();
  virtual ~GraphicalCSClient();
