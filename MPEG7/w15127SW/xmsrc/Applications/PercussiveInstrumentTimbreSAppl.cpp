...
//
// Applicable File Name:  PercussiveInstrumentTimbreSAppl.cpp
//
...
const UUID PercussiveInstrumentTimbreServer::myID = UUID("");
const char *PercussiveInstrumentTimbreServer::myName = "PercussiveInstrumentTimbreServer";

//=============================================================================
PercussiveInstrumentTimbreServer::PercussiveInstrumentTimbreServer()
{
}
...
unsigned long PercussiveInstrumentTimbreServer::Start(char *ListFile, char *Bitstream)
{
  ...
  // This sets up a binary file io with a buffer size of 512bytes (I think)
	...
	if (CodingMode == 2) { // Binary coding
	    ...
	    theBinCS = new PercussiveInstrumentTimbreCS(theDescriptorInterface);
	...
	fprintf(stderr,"PercussiveInstrumentTimbreServer::Start: Allocation error\n");
	return(1);
    }
...
//----------------------------------------------------------------------------
unsigned long PercussiveInstrumentTimbreServer::Stop()
{
    return(0);
}
...
//----------------------------------------------------------------------------
unsigned long PercussiveInstrumentTimbreServer::Open()
{
    return(0);
}
...
//----------------------------------------------------------------------------
unsigned long PercussiveInstrumentTimbreServer::Close()
{
    return(0);
}
...
//----------------------------------------------------------------------------
const UUID& PercussiveInstrumentTimbreServer::GetObjectID(void)
{ 
    return(myID);
}

//----------------------------------------------------------------------------
const char *PercussiveInstrumentTimbreServer::GetName(void)
{ 
    return(myName); 
}
