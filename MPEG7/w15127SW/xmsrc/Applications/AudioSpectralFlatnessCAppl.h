...
//
// Applicable File Name:  AudioSpectralFlatnessCAppl.h
//

#ifndef __AUDIOSPECTRALFLATNESSCLIENT__
#define __AUDIOSPECTRALFLATNESSCLIENT__
...
//=============================================================================
class AudioSpectralFlatnessClient: public ClientApplication
{
public:
  AudioSpectralFlatnessClient();
  virtual ~AudioSpectralFlatnessClient();
...
private:
  ...
  //--- expect query as ddl description
  GenericDS QueryDescription;
  char * DDLFilename;
...
#endif //__AUDIOSPECTRALFLATNESS__
