...
#ifndef __DEPEND_STRUCTURE__
#define __DEPEND_STRUCTURE__
...
//=============================================================================
class DependStructureClient: public ClientApplication
{
public:
	DependStructureClient();
	virtual ~DependStructureClient();
