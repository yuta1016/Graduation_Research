...
//
// Applicable File Name:  CTBrowsingSAppl.h
//
#ifndef __CTBROWSINGSERVER__
#define __CTBROWSINGSERVER__
...
class CTBrowsingServer: public ServerApplication
{
public:
  // Null constructor
  CTBrowsingServer();
