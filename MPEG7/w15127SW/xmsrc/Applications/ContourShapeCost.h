...
//
// Applicable File Name:  ContourShapeCAppl.h
//
///////////////////////////////////////////////////////////////////////////////

#ifndef __CONTOUR_SHAPE_COST__
#define __CONTOUR_SHAPE_COST__
...
//=============================================================================
class ContourShapeCost: public ClientApplication
{
public:
        ContourShapeCost();
        virtual ~ContourShapeCost();

        virtual unsigned long Open(char *ListFile, char *Bitstream);
        virtual unsigned long Start(int NoOfMatches);
...
private:
	...
	ContourShapeDescriptor **DBContourShapeDescription;

	int Count(MatchList &list, const char *className);
};
};

#endif //__CONTOUR_SHAPE_COST__
