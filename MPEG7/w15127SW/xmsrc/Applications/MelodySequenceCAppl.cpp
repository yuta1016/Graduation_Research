...
//
// Applicable File Name:  MelodySequenceCAppl.cpp
//
...
const UUID MelodySequenceClient::myID = UUID("");
const char *MelodySequenceClient::myName = "MelodySequenceClient";

//=============================================================================
MelodySequenceClient::MelodySequenceClient():
RamDB(),
NoOfElements(0),
DBDescription(0)
{
...
//----------------------------------------------------------------------------
unsigned long MelodySequenceClient::Open(char *ListFile, char *DDLFile)
{
  DDLFilename = DDLFile;
  ...
  try{
    ...
    fprintf(stderr,"MelodySequenceClient::Open: Allocation error\n");
    return(1);
  }
  ...
  try{
    ...
    fprintf(stderr,"MelodySequenceClient::Open: Allocation error2\n");
    return(1);
  }
...
//----------------------------------------------------------------------------
unsigned long MelodySequenceClient::Start(char *Query,int NoOfMatches)
{
  // Check data is sane
  assert(Query       != NULL);
  ...
  MelodySequenceSearchTool*         theSearchTool              = NULL;
  MelodySequenceSearchInterfaceABC* theSearchInterface         = NULL;


  try{
    // Create search tool
    theSearchTool = new MelodySequenceSearchTool(theDocumentInterfaceABC );
    ...
    fprintf(stderr,"MelodySequenceClient::Start: Allocation error1\n");
    return(1);
  }
...
//----------------------------------------------------------------------------
unsigned long MelodySequenceClient::Stop()
{
  // fprintf(stderr,"MelodySequenceClient::Stop: Not Implemented");
  return 0;
}


//----------------------------------------------------------------------------
unsigned long MelodySequenceClient::Close()
{
  // Free memories
  RamDB.FreeDatabase();
...
//----------------------------------------------------------------------------
const UUID& MelodySequenceClient::GetObjectID(void)
{ return myID; }

//----------------------------------------------------------------------------
const char *MelodySequenceClient::GetName(void)
{ return myName; }
