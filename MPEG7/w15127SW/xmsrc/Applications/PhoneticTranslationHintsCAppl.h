////////////////////////////////////////////////////////////////////////
//
// PhoneticTranslationHintsCAppl.h
//
...
#ifndef __PHONETIC_TRANSLATION_HINTS_CLIENT__
#define __PHONETIC_TRANSLATION_HINTS_CLIENT__
...
//=============================================================================
class PhoneticTranslationHintsClient: public ClientApplication
{
public:
	PhoneticTranslationHintsClient();
	virtual ~PhoneticTranslationHintsClient();

	virtual unsigned long Open(char *ListFile);
	virtual unsigned long Start(char *Query);
...
#endif //__PHONETIC_TRANSLATION_HINTS_CLIENT__
