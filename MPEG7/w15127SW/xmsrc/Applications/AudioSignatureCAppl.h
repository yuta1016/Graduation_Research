...
//
// Applicable File Name:  AudioSignatureCAppl.h
//

#ifndef __AUDIOSIGNATURECLIENT__
#define __AUDIOSIGNATURECLIENT__
...
//=============================================================================
class AudioSignatureClient: public ClientApplication
{
public:
  AudioSignatureClient();
  virtual ~AudioSignatureClient();
...
#endif //__AUDIOSIGNATURECLIENT__
