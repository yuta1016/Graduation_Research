...
//
// Applicable File Name:  StateMemberCAppl.cpp
//
...
const UUID StateMemberClient::myID = UUID("");
const char *StateMemberClient::myName = "StateMemberClient";

//=============================================================================
StateMemberClient::StateMemberClient():
RamDB(),
NoOfElements(0),
DBDescription(0)
{
...
//----------------------------------------------------------------------------
unsigned long StateMemberClient::Open(char *ListFile, char *DDLFile)
{
  ...
  // This sets up the StateMember descriptor interface
  ...
  try{
    ...
    fprintf(stderr,"StateMemberClient::Open: Allocation error\n");
    return(1);
  }
  ...
  try{
    ...
    fprintf(stderr,"StateMemberClient::Open: Allocation error2\n");
    return(1);
  }
...
//----------------------------------------------------------------------------
unsigned long StateMemberClient::Start(char *Query,int NoOfMatches)
{
  // Check data is sane
  assert(Query       != NULL);
  ...
  StateMemberSearchTool*         theSearchTool              = NULL;
  StateMemberSearchInterfaceABC* theSearchInterface         = NULL;
  ...
  try {  
    ...
    // Create search tool
    theSearchTool = new StateMemberSearchTool(theDescriptionInterface);
    ...
    fprintf(stderr,"StateMemberClient::Start: Allocation error1\n");
    return(1);
  }
...
//----------------------------------------------------------------------------
unsigned long StateMemberClient::Stop()
{
  // fprintf(stderr,"StateMemberClient::Stop: Not Implemented");
  return 0;
}
//----------------------------------------------------------------------------
unsigned long StateMemberClient::Close()
{
  // Free memories
  RamDB.FreeDatabase();
...
//----------------------------------------------------------------------------
const UUID& StateMemberClient::GetObjectID(void)
{ return myID; }

//----------------------------------------------------------------------------
const char *StateMemberClient::GetName(void)
{ return myName; }
