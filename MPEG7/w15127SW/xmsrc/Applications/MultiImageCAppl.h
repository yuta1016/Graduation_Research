...
#ifndef __MULTIIMAGECLIENT__
#define __MULTIIMAGECLIENT__
...
//=============================================================================
class MultiImageClient: public ClientApplication
{
public:
  MultiImageClient();
  virtual ~MultiImageClient();
...
private:
  ...
  MultiImageDescriptor **DBDescription;
};
};

#endif //__MULTIIMAGECLIENT__
