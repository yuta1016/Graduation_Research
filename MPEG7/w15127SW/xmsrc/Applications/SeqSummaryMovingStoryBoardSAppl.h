...
//
// Applicable File Name:  SeqSummaryMovingStoryBoardSAppl.h
//
#ifndef __SEQSUMMARYMOVINGSTORYBOARD_SERVER__
#define __SEQSUMMARYMOVINGSTORYBOARD_SERVER__
...
//=============================================================================
class SeqSummaryMovingStoryBoardServer : public ServerApplication
{
public:
	SeqSummaryMovingStoryBoardServer();
	virtual ~SeqSummaryMovingStoryBoardServer();
...
#endif //__SUMMARIZATION_SERVER__
