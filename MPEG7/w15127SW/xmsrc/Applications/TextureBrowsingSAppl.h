...
//
// Applicable File Name:  TextureBrowsingSAppl.h
//
#ifndef __TEXTURE_BROWSING_SERVER__
#define __TEXTURE_BROWSING_SERVER__
...
// texture browsing type. 
//==============================================================================

class TextureBrowsingServer: public ServerApplication
{
public:
  // Null constructor
  TextureBrowsingServer();

  // Destructor
  virtual ~TextureBrowsingServer();
...
#endif //__TEXTURE_BROWSING_SERVER__
