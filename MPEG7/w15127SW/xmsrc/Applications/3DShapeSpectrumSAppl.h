...
//
// Applicable File Name:  3DShapeSpectrumSAppl.h
//
#ifndef __SHAPE_SPECTRUM_SERVER__
#define __SHAPE_SPECTRUM_SERVER__
...
//=============================================================================
class ShapeSpectrumServer: public ServerApplication
{
public:
	ShapeSpectrumServer();
	virtual ~ShapeSpectrumServer();
...
#endif //__SHAPE_SPECTRUM_SERVER__
